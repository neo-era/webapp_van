...
const EXAMS = {
  TOAN: [
    ...
    {
      examId: 'toan-bank-1', title: 'Luyện tập — Khảo sát hàm số & Mũ–Logarit', durationMin: 45,
      questions: [
        { stem: 'Hàm số $y=x^3-3x^2$ đồng biến trên khoảng nào?', options: ['$(2;+\\infty)$', '$(0;2)$', '$(-\\infty;0)$', '$(0;+\\infty)$'], answer: 0, explanation: "$y'=3x^2-6x>0\\Leftrightarrow x<0$ hoặc $x>2$." },
        { stem: 'Số tiệm cận đứng của đồ thị $y=\\dfrac{1}{x-1}$?', options: ['$0$', '$1$', '$2$', '$3$'], answer: 1, explanation: 'Mẫu $=0$ tại $x=1$ ⇒ 1 tiệm cận đứng.' },
        { stem: 'Giá trị cực đại của $y=-x^2+2x+3$?', options: ['$3$', '$1$', '$4$', '$5$'], answer: 2, explanation: '$y=-(x-1)^2+4\\le4$, cực đại $=4$.' },
        { stem: 'Tính $\\log_3 27$.', options: ['$2$', '$9$', '$27$', '$3$'], answer: 3, explanation: '$\\log_3 3^3=3$.' },
        { stem: 'Đạo hàm của $y=\\ln(2x)$?', options: ['$\\dfrac1x$', '$\\dfrac2x$', '$\\dfrac1{2x}$', '$\\ln 2$'], answer: 0, explanation: '$(\\ln 2x)\'=\\dfrac{2}{2x}=\\dfrac1x$.' },
        { stem: 'Nghiệm của $2^x=\\dfrac18$?', options: ['$3$', '$-3$', '$-2$', '$8$'], answer: 1, explanation: '$2^x=2^{-3}\\Rightarrow x=-3$.' },
        { stem: 'Hàm số $y=x^4-2x^2$ có bao nhiêu điểm cực trị?', options: ['$1$', '$2$', '$3$', '$0$'], answer: 2, explanation: "$y'=4x(x^2-1)=0\\Rightarrow x=0,\\pm1$ ⇒ 3 cực trị." },
        { stem: 'GTNN của $y=x+\\dfrac4x$ với $x>0$?', options: ['$2$', '$8$', '$1$', '$4$'], answer: 3, explanation: 'AM–GM: $\\ge2\\sqrt4=4$, dấu "=" khi $x=2$.' },
        { stem: 'Tiệm cận ngang của $y=\\dfrac{x+1}{x-2}$?', options: ['$y=1$', '$y=-1$', '$y=2$', '$y=\\tfrac12$'], answer: 0, explanation: 'Bậc tử = bậc mẫu ⇒ TCN $y=1$.' },
        { stem: 'Tính $\\log_2 8-\\log_2 2$.', options: ['$1$', '$2$', '$3$', '$4$'], answer: 1, explanation: '$3-1=2$.' },
      ],
    },
    {
