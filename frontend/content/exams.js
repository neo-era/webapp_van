...
const EXAMS = {
  ...
  LY: [
    ...
    {
      examId: 'ly-thptqg-1', title: '🎯 Đề thi thử THPT QG — Vật lí (theo cấu trúc, 50 phút)', durationMin: 50,
      questions: [
        { stem: 'Đổi $27$ °C sang thang Kelvin?', options: ['$273$ K', '$327$ K', '$246$ K', '$300$ K'], answer: 3, explanation: '$27+273=300$ K.' },
        { stem: 'Nén đẳng nhiệt khí từ $p_1=2$ atm, $V_1=4$ L về $V_2=2$ L. Áp suất $p_2$?', options: ['$2$ atm', '$8$ atm', '$4$ atm', '$1$ atm'], answer: 2, explanation: '$p_1V_1=p_2V_2\\Rightarrow p_2=\\dfrac{2\\cdot4}{2}=4$ atm.' },
        { stem: 'Lực từ lên dây dẫn $l=0{,}5$ m mang $I=5$ A vuông góc $B=0{,}2$ T?', options: ['$0{,}5$ N', '$0{,}2$ N', '$1$ N', '$5$ N'], answer: 0, explanation: '$F=BIl=0{,}2\\cdot5\\cdot0{,}5=0{,}5$ N.' },
        { stem: 'Sau $3$ chu kì bán rã, lượng chất phóng xạ còn lại?', options: ['$\\tfrac12$', '$\\tfrac14$', '$\\tfrac18$', '$\\tfrac1{16}$'], answer: 2, explanation: '$2^{-3}=\\tfrac18$.' },
        { stem: 'Đơn vị của cảm ứng từ là?', options: ['Vôn', 'Tesla', 'Ampe', 'Oát'], answer: 1, explanation: 'Cảm ứng từ $B$ đo bằng Tesla (T).' },
        { stem: 'Nhiệt lượng để đun $2$ kg nước tăng $10^\\circ C$ ($c=4200$)?', options: ['$42000$ J', '$8400$ J', '$84000$ J', '$420000$ J'], answer: 2, explanation: '$Q=mc\\Delta t=2\\cdot4200\\cdot10=84000$ J.' },
        { stem: 'Số neutron trong hạt nhân $^{14}_{6}C$?', options: ['$6$', '$8$', '$14$', '$20$'], answer: 1, explanation: '$N=14-6=8$.' },
        { stem: 'Đun đẳng tích khí từ $T_1=300$ K, $p_1=1$ atm đến $T_2=600$ K. $p_2$?', options: ['$1$ atm', '$3$ atm', '$2$ atm', '$0{,}5$ atm'], answer: 2, explanation: '$\\dfrac{p_1}{T_1}=\\dfrac{p_2}{T_2}\\Rightarrow p_2=2$ atm.' },
        { stem: 'Hạt nhân có năng lượng liên kết riêng càng lớn thì?', options: ['càng kém bền', 'càng bền vững', 'càng dễ phóng xạ', 'không đổi'], answer: 1, explanation: 'Năng lượng liên kết riêng lớn ⇒ hạt nhân bền vững.' },
        { stem: 'Thiết bị tiêu thụ công $A=2000$ J trong $t=4$ s có công suất?', options: ['$8000$ W', '$500$ W', '$2000$ W', '$250$ W'], answer: 1, explanation: '$P=A/t=2000/4=500$ W.' },
        { stem: 'Lực Lorentz tác dụng lên hạt mang điện đứng yên ($v=0$)?', options: ['$0$', '$qB$', '$qvB$', 'cực đại'], answer: 0, explanation: '$f=qvB\\sin\\theta=0$ khi $v=0$.' },
        { stem: 'Khí nhận nhiệt $Q=200$ J và nhận công $A=100$ J. Độ biến thiên nội năng?', options: ['$100$ J', '$200$ J', '$300$ J', '$-100$ J'], answer: 2, explanation: '$\\Delta U=Q+A=300$ J.' },
      ],
    },
    {
