...
const EXAMS = {
  ...
  LY: [
    ...
    {
      examId: 'ly-hsg-1', title: '🏆 Đề thi HSG — Vật lí 12 (150 phút)', durationMin: 150,
      questions: [
        { stem: 'Hạt nhân $^{235}_{92}U$ có bao nhiêu neutron?', options: ['$143$', '$92$', '$235$', '$327$'], answer: 0, explanation: '$N=235-92=143$.' },
        { stem: 'Độ hụt khối $\\Delta m=0{,}1\\,u$. Năng lượng liên kết (MeV)?', options: ['$9{,}315$', '$93{,}15$', '$931{,}5$', '$0{,}9315$'], answer: 1, explanation: '$E=0{,}1\\cdot931{,}5=93{,}15$ MeV.' },
        { stem: 'Đẳng áp: $V_1=2$ L ở $T_1=300$ K. Thể tích ở $T_2=600$ K?', options: ['$2$ L', '$3$ L', '$4$ L', '$6$ L'], answer: 2, explanation: '$\\dfrac{V_1}{T_1}=\\dfrac{V_2}{T_2}\\Rightarrow V_2=4$ L.' },
        { stem: 'Lực Lorentz: $q=1{,}6\\cdot10^{-19}$ C, $v=2\\cdot10^6$ m/s vuông góc $B=0{,}5$ T?', options: ['$1{,}6\\cdot10^{-14}$ N', '$1{,}6\\cdot10^{-13}$ N', '$3{,}2\\cdot10^{-13}$ N', '$8\\cdot10^{-14}$ N'], answer: 1, explanation: '$f=qvB=1{,}6\\cdot10^{-19}\\cdot2\\cdot10^6\\cdot0{,}5=1{,}6\\cdot10^{-13}$ N.' },
        { stem: 'Sau bao nhiêu chu kì bán rã thì còn $6{,}25\\%$ lượng ban đầu?', options: ['$3$', '$5$', '$6$', '$4$'], answer: 3, explanation: '$6{,}25\\%=\\tfrac1{16}=2^{-4}$ ⇒ 4 chu kì.' },
        { stem: 'Hiệu suất động cơ nhiệt nhận $Q=1000$ J, sinh công $A=300$ J?', options: ['$40\\%$', '$30\\%$', '$33\\%$', '$70\\%$'], answer: 1, explanation: '$H=A/Q=300/1000=30\\%$.' },
        { stem: 'Cảm ứng từ cách dòng điện thẳng $I=10$ A một khoảng $r=0{,}05$ m?', options: ['$2\\cdot10^{-5}$ T', '$8\\cdot10^{-5}$ T', '$4\\cdot10^{-5}$ T', '$10^{-5}$ T'], answer: 2, explanation: '$B=2\\cdot10^{-7}\\cdot\\dfrac{10}{0{,}05}=4\\cdot10^{-5}$ T.' },
        { stem: 'Phản ứng hạt nhân tỏa năng lượng khi tổng khối lượng các hạt sau phản ứng?', options: ['lớn hơn trước', 'nhỏ hơn trước', 'bằng trước', 'không liên quan'], answer: 1, explanation: 'Khối lượng giảm ⇒ năng lượng tỏa ra theo $E=\\Delta m c^2$.' },
        { stem: 'Công khí thực hiện khi đẳng áp $p=10^5$ Pa, $\\Delta V=0{,}002$ m³?', options: ['$100$ J', '$2000$ J', '$200$ J', '$20$ J'], answer: 2, explanation: '$A=p\\Delta V=10^5\\cdot0{,}002=200$ J.' },
        { stem: 'Nhiệt lượng đun $1$ kg nước từ $20^\\circ C$ đến $100^\\circ C$ ($c=4200$)?', options: ['$168000$ J', '$33600$ J', '$336000$ J', '$420000$ J'], answer: 2, explanation: '$Q=1\\cdot4200\\cdot80=336000$ J.' },
      ],
    },
  ],
