...
const EXAMS = {
  TOAN: [
    ...
    {
      examId: 'toan-bank-2', title: 'Luyện tập — Tích phân & Hình Oxyz', durationMin: 45,
      questions: [
        { stem: 'Tính $\\displaystyle\\int_0^1 3x^2\\,dx$.', options: ['$1$', '$3$', '$2$', '$\\tfrac13$'], answer: 0, explanation: '$[x^3]_0^1=1$.' },
        { stem: 'Tìm $\\displaystyle\\int \\dfrac{dx}{x}$.', options: ['$-\\dfrac1{x^2}+C$', '$\\ln|x|+C$', '$x\\ln x+C$', '$\\dfrac1{x^2}+C$'], answer: 1, explanation: '$\\int\\dfrac{dx}{x}=\\ln|x|+C$.' },
        { stem: 'Khoảng cách từ $O$ đến mặt phẳng $x+2y+2z-6=0$?', options: ['$1$', '$3$', '$2$', '$6$'], answer: 2, explanation: '$\\dfrac{|-6|}{\\sqrt{1+4+4}}=2$.' },
        { stem: 'Bán kính mặt cầu $x^2+y^2+z^2-4x=0$?', options: ['$1$', '$4$', '$\\sqrt2$', '$2$'], answer: 3, explanation: '$(x-2)^2+y^2+z^2=4\\Rightarrow R=2$.' },
        { stem: 'Tính $\\displaystyle\\int_0^\\pi \\sin x\\,dx$.', options: ['$2$', '$0$', '$1$', '$-2$'], answer: 0, explanation: '$[-\\cos x]_0^\\pi=1+1=2$.' },
        { stem: 'Vectơ pháp tuyến của mặt phẳng $2x-3y+z-1=0$?', options: ['$(2;3;1)$', '$(2;-3;1)$', '$(-3;1;2)$', '$(2;-3;-1)$'], answer: 1, explanation: 'Hệ số $(2;-3;1)$.' },
        { stem: 'Tìm $\\displaystyle\\int e^{2x}\\,dx$.', options: ['$e^{2x}+C$', '$2e^{2x}+C$', '$\\tfrac12 e^{2x}+C$', '$\\dfrac{e^{2x}}{x}+C$'], answer: 2, explanation: '$\\int e^{2x}dx=\\tfrac12 e^{2x}+C$.' },
        { stem: 'Diện tích hình phẳng giới hạn bởi $y=x^2$ và $y=2x$?', options: ['$\\tfrac23$', '$2$', '$\\tfrac83$', '$\\tfrac43$'], answer: 3, explanation: '$\\int_0^2(2x-x^2)dx=4-\\tfrac83=\\tfrac43$.' },
        { stem: 'Trung điểm của $A(2;0;4)$ và $B(0;2;0)$?', options: ['$(1;1;2)$', '$(2;2;4)$', '$(1;1;0)$', '$(2;1;2)$'], answer: 0, explanation: 'Trung bình từng tọa độ $\\Rightarrow(1;1;2)$.' },
        { stem: 'Tính $\\displaystyle\\int_1^2 2x\\,dx$.', options: ['$2$', '$4$', '$3$', '$1$'], answer: 2, explanation: '$[x^2]_1^2=4-1=3$.' },
      ],
    },
    {
      examId: 'toan-bank-3', title: 'Luyện tập — Tổ hợp, Xác suất & Thống kê', durationMin: 45,
      questions: [
        { stem: 'Tính $C_6^2$.', options: ['$15$', '$30$', '$12$', '$36$'], answer: 0, explanation: '$\\dfrac{6!}{2!4!}=15$.' },
        { stem: 'Gieo hai con xúc xắc, xác suất tổng số chấm bằng $7$?', options: ['$\\tfrac15$', '$\\tfrac16$', '$\\tfrac1{12}$', '$\\tfrac19$'], answer: 1, explanation: '$6$ cách $/36=\\tfrac16$.' },
        { stem: 'Số trung bình cộng của $4,6,8,10$?', options: ['$6$', '$8$', '$7$', '$9$'], answer: 2, explanation: '$\\dfrac{28}{4}=7$.' },
        { stem: 'Hai biến cố độc lập $P(A)=0{,}3$, $P(B)=0{,}4$. Tính $P(A\\cap B)$.', options: ['$0{,}7$', '$0{,}1$', '$0{,}5$', '$0{,}12$'], answer: 3, explanation: '$0{,}3\\cdot0{,}4=0{,}12$.' },
        { stem: 'Số hoán vị của $4$ phần tử khác nhau?', options: ['$24$', '$12$', '$16$', '$4$'], answer: 0, explanation: '$4!=24$.' },
        { stem: 'Cho $P(A\\cap B)=0{,}2$, $P(B)=0{,}5$. Tính $P(A\\mid B)$.', options: ['$0{,}1$', '$0{,}4$', '$0{,}25$', '$0{,}7$'], answer: 1, explanation: '$\\dfrac{0{,}2}{0{,}5}=0{,}4$.' },
        { stem: 'Phương sai của mẫu $2,2,2,2$?', options: ['$2$', '$1$', '$0$', '$4$'], answer: 2, explanation: 'Mọi giá trị bằng nhau ⇒ phương sai $=0$.' },
        { stem: 'Số cách xếp $3$ người vào $3$ ghế?', options: ['$3$', '$9$', '$1$', '$6$'], answer: 3, explanation: '$3!=6$.' },
        { stem: 'Giá trị $C_n^0$ bằng?', options: ['$1$', '$n$', '$0$', '$n!$'], answer: 0, explanation: '$C_n^0=1$.' },
        { stem: 'Gieo đồng xu cân đối $2$ lần, xác suất được $2$ mặt ngửa?', options: ['$\\tfrac12$', '$\\tfrac14$', '$\\tfrac13$', '$\\tfrac34$'], answer: 1, explanation: '$\\tfrac12\\cdot\\tfrac12=\\tfrac14$.' },
      ],
    },
  ],
