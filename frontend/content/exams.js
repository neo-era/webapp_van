...
const EXAMS = {
  TOAN: [
    ...
    {
      examId: 'toan-thptqg-1', title: '🎯 Đề thi thử THPT QG — Toán (theo cấu trúc, 90 phút)', durationMin: 90,
      questions: [
        { stem: 'Hàm số $y=x^3-3x+1$ có bao nhiêu điểm cực trị?', options: ['$1$', '$2$', '$3$', '$0$'], answer: 1, explanation: '$y\'=3x^2-3=0\\Rightarrow x=\\pm1$ ⇒ 2 cực trị.' },
        { stem: 'Tập xác định của $y=\\ln(x-2)$ là?', options: ['$\\mathbb{R}\\setminus\\{2\\}$', '$(-\\infty;2)$', '$(2;+\\infty)$', '$[2;+\\infty)$'], answer: 2, explanation: 'Điều kiện $x-2>0\\Rightarrow x>2$.' },
        { stem: 'Tính $\\displaystyle\\int (2x+1)\\,dx$.', options: ['$x^2+x+C$', '$2x^2+x+C$', '$x^2+C$', '$x^2+2x+C$'], answer: 0, explanation: '$\\int(2x+1)dx=x^2+x+C$.' },
        { stem: 'Nghiệm của phương trình $2^x=8$ là?', options: ['$2$', '$4$', '$8$', '$3$'], answer: 3, explanation: '$2^x=2^3\\Rightarrow x=3$.' },
        { stem: 'Đạo hàm của $y=e^{2x}$ là?', options: ['$e^{2x}$', '$2xe^{2x}$', '$2e^{2x}$', '$\\tfrac12 e^{2x}$'], answer: 2, explanation: '$(e^{2x})\'=2e^{2x}$.' },
        { stem: 'Mặt phẳng $(P): 2x-y+2z-3=0$ có một vectơ pháp tuyến là?', options: ['$(2;1;2)$', '$(2;-1;2)$', '$(-1;2;2)$', '$(2;-1;-3)$'], answer: 1, explanation: 'Hệ số của $x,y,z$ là $(2;-1;2)$.' },
        { stem: 'Khoảng cách từ gốc $O$ đến mặt phẳng $2x-2y+z+6=0$?', options: ['$3$', '$6$', '$2$', '$1$'], answer: 2, explanation: '$d=\\dfrac{|6|}{\\sqrt{4+4+1}}=\\dfrac{6}{3}=2$.' },
        { stem: 'Tính $\\displaystyle\\int_0^1 e^x\\,dx$.', options: ['$e$', '$e+1$', '$1-e$', '$e-1$'], answer: 3, explanation: '$[e^x]_0^1=e-1$.' },
        { stem: 'Tiệm cận ngang của đồ thị $y=\\dfrac{2x-1}{x+1}$ là?', options: ['$y=2$', '$y=1$', '$y=-1$', '$y=\\tfrac12$'], answer: 0, explanation: 'Bậc tử = bậc mẫu ⇒ TCN $y=\\dfrac{2}{1}=2$.' },
        { stem: 'Thể tích khối tròn xoay khi quay $y=x$ ($0\\le x\\le1$) quanh $Ox$?', options: ['$\\pi$', '$\\dfrac{\\pi}{3}$', '$\\dfrac{\\pi}{2}$', '$\\dfrac{2\\pi}{3}$'], answer: 1, explanation: '$V=\\pi\\int_0^1 x^2dx=\\dfrac{\\pi}{3}$.' },
        { stem: 'Gieo một con xúc xắc cân đối. Xác suất xuất hiện mặt có số chấm là số nguyên tố ($2,3,5$)?', options: ['$\\tfrac13$', '$\\tfrac23$', '$\\tfrac16$', '$\\tfrac12$'], answer: 3, explanation: '3 kết quả thuận lợi / 6 ⇒ $\\tfrac12$.' },
        { stem: 'Giá trị $\\log_2 8 + \\log_2 2$ bằng?', options: ['$4$', '$3$', '$5$', '$16$'], answer: 0, explanation: '$3+1=4$.' },
        { stem: 'GTLN của $y=-x^2+4x-1$ trên $\\mathbb{R}$?', options: ['$4$', '$3$', '$-1$', '$2$'], answer: 1, explanation: '$y=-(x-2)^2+3\\le3$.' },
        { stem: 'Số trung bình cộng của mẫu $2,4,6,8,10$?', options: ['$5$', '$7$', '$6$', '$8$'], answer: 2, explanation: '$\\dfrac{30}{5}=6$.' },
        { stem: 'Họ nguyên hàm của $\\cos x$ là?', options: ['$\\sin x+C$', '$-\\sin x+C$', '$\\cos x+C$', '$-\\cos x+C$'], answer: 0, explanation: '$\\int\\cos x\\,dx=\\sin x+C$.' },
      ],
    },
    {
