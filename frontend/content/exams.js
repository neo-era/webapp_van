...
const EXAMS = {
  TOAN: [
    ...
    {
      examId: 'toan-hsg-1', title: '🏆 Đề thi HSG — Toán 12 (150 phút)', durationMin: 150,
      questions: [
        { stem: 'Cho $a+b+c=0$. Khi đó $a^3+b^3+c^3$ bằng?', options: ['$0$', '$3abc$', '$abc$', '$-3abc$'], answer: 1, explanation: 'Khi $a+b+c=0$ thì $a^3+b^3+c^3=3abc$.' },
        { stem: 'GTNN của $f(x)=x+\\dfrac{1}{x}$ với $x>0$?', options: ['$2$', '$1$', '$0$', '$4$'], answer: 0, explanation: 'AM–GM: $x+\\tfrac1x\\ge2$, dấu "=" khi $x=1$.' },
        { stem: 'Số nghiệm nguyên dương của $xy=x+y$?', options: ['vô số', '$0$', '$1$', '$2$'], answer: 2, explanation: '$(x-1)(y-1)=1\\Rightarrow x=y=2$ ⇒ đúng 1 nghiệm.' },
        { stem: 'Với mọi số nguyên $n$, $n^3-n$ luôn chia hết cho?', options: ['$4$', '$5$', '$7$', '$6$'], answer: 3, explanation: '$n^3-n=(n-1)n(n+1)$ — tích 3 số liên tiếp ⇒ chia hết cho 6.' },
        { stem: 'GTNN của $g(x)=x^2-6x+11$?', options: ['$3$', '$2$', '$1$', '$-2$'], answer: 1, explanation: '$g=(x-3)^2+2\\ge2$.' },
        { stem: 'Số dư khi chia $2^{100}$ cho $3$?', options: ['$0$', '$2$', '$1$', 'không xác định'], answer: 2, explanation: '$2\\equiv-1\\Rightarrow 2^{100}\\equiv1\\ (\\text{mod }3)$.' },
        { stem: 'Phân tích $x^4+4$ thành tích hai tam thức bậc hai, một thừa số là?', options: ['$x^2+4$', '$x^2+2x+2$', '$x^2-4$', '$x^2+x+2$'], answer: 1, explanation: '$x^4+4=(x^2-2x+2)(x^2+2x+2)$.' },
        { stem: '$\\triangle ABC$ có $AB=6, AC=4$, phân giác trong $AD$ ($D\\in BC$). Tỉ số $\\dfrac{BD}{DC}$?', options: ['$\\tfrac23$', '$\\tfrac43$', '$\\tfrac32$', '$1$'], answer: 2, explanation: '$\\dfrac{BD}{DC}=\\dfrac{AB}{AC}=\\dfrac{6}{4}=\\dfrac32$.' },
        { stem: 'Với $a,b>0$, giá trị nhỏ nhất của $(a+b)\\left(\\dfrac1a+\\dfrac1b\\right)$?', options: ['$4$', '$3$', '$2$', '$1$'], answer: 0, explanation: '$=2+\\dfrac ab+\\dfrac ba\\ge4$.' },
        { stem: 'Với $a,b,c>0$: $\\dfrac ab+\\dfrac bc+\\dfrac ca \\ge$ ?', options: ['$1$', '$2$', '$3$', '$4$'], answer: 2, explanation: 'AM–GM ba số ⇒ $\\ge3\\sqrt[3]{1}=3$.' },
      ],
    },
    {
