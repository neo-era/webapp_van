...
const EXAMS = {
  ...
  HOA: [
    ...
    {
      examId: 'hoa-hsg-1', title: '🏆 Đề thi HSG — Hóa học 12 (150 phút)', durationMin: 150,
      questions: [
        { stem: 'Xà phòng hóa $8{,}8$ g $CH_3COOC_2H_5$ ($M=88$) thu được muối $CH_3COONa$ ($M=82$) bao nhiêu gam?', options: ['$8{,}2$', '$8{,}8$', '$4{,}1$', '$16{,}4$'], answer: 0, explanation: '$n=0{,}1\\Rightarrow m=0{,}1\\cdot82=8{,}2$ g.' },
        { stem: 'Cho $5{,}6$ g Fe vào $CuSO_4$ dư. Khối lượng Cu sinh ra?', options: ['$5{,}6$ g', '$6{,}4$ g', '$3{,}2$ g', '$12{,}8$ g'], answer: 1, explanation: '$n_{Fe}=0{,}1\\Rightarrow m_{Cu}=0{,}1\\cdot64=6{,}4$ g.' },
        { stem: 'Số mắt xích của PVC có $M=62500$ (monome $M=62{,}5$)?', options: ['$500$', '$2000$', '$1000$', '$100$'], answer: 2, explanation: '$n=62500/62{,}5=1000$.' },
        { stem: 'Đốt cháy hoàn toàn ester no, đơn chức, mạch hở thì:', options: ['$n_{CO_2}>n_{H_2O}$', '$n_{CO_2}=n_{H_2O}$', '$n_{CO_2}<n_{H_2O}$', 'không xác định'], answer: 1, explanation: 'Ester no đơn chức hở ⇒ $n_{CO_2}=n_{H_2O}$.' },
        { stem: 'Glyxin $H_2N\\text{-}CH_2\\text{-}COOH$ tác dụng được với?', options: ['chỉ HCl', 'chỉ NaOH', 'cả HCl và NaOH', 'không chất nào'], answer: 2, explanation: 'Tính lưỡng tính ⇒ phản ứng cả acid và base.' },
        { stem: 'Cho $0{,}2$ mol Zn vào $CuSO_4$ dư. Khối lượng Cu thu được?', options: ['$6{,}4$ g', '$3{,}2$ g', '$12{,}8$ g', '$25{,}6$ g'], answer: 2, explanation: '$n_{Cu}=0{,}2\\Rightarrow m=12{,}8$ g.' },
        { stem: 'Phần trăm khối lượng C trong $CH_4$ ($M=16$)?', options: ['$25\\%$', '$80\\%$', '$75\\%$', '$50\\%$'], answer: 2, explanation: '$12/16\\cdot100\\%=75\\%$.' },
        { stem: 'Số đồng phân amine bậc một ứng với $C_3H_9N$?', options: ['$1$', '$3$', '$4$', '$2$'], answer: 3, explanation: '$CH_3CH_2CH_2NH_2$ và $(CH_3)_2CHNH_2$ ⇒ 2 đồng phân.' },
        { stem: 'Xà phòng hóa chất béo (trieste của glycerol) thu được?', options: ['glucose', 'glycerol và muối của acid béo', 'ethanol', 'tinh bột'], answer: 1, explanation: 'Sản phẩm là glycerol và xà phòng (muối acid béo).' },
        { stem: 'Cho $0{,}1$ mol Fe tác dụng HCl dư. Thể tích $H_2$ (đktc)?', options: ['$1{,}12$ L', '$2{,}24$ L', '$3{,}36$ L', '$4{,}48$ L'], answer: 1, explanation: '$Fe+2HCl\\to FeCl_2+H_2$ ⇒ $V=0{,}1\\cdot22{,}4=2{,}24$ L.' },
      ],
    },
  ],
  ...
  ANH: [
    ...
    {
      examId: 'anh-thptqg-1', title: '🎯 Đề thi thử THPT QG — Tiếng Anh (theo cấu trúc, 50 phút)', durationMin: 50,
      questions: [
        { stem: 'She ____ to school every day.', options: ['go', 'goes', 'going', 'went'], answer: 1, explanation: 'Hiện tại đơn, ngôi 3 số ít ⇒ goes.' },
        { stem: 'This song ____ by many young people.', options: ['sings', 'sang', 'is sung', 'sung'], answer: 2, explanation: 'Bị động hiện tại đơn ⇒ is sung.' },
        { stem: 'If I ____ rich, I would travel around the world.', options: ['am', 'was', 'were', 'will be'], answer: 2, explanation: 'Điều kiện loại 2 ⇒ were.' },
        { stem: 'He said he ____ tired.', options: ['is', 'will', 'be', 'was'], answer: 3, explanation: 'Tường thuật lùi thì: is → was.' },
        { stem: 'The man ____ helped me is my neighbour.', options: ['which', 'whose', 'who', 'where'], answer: 2, explanation: 'Chỉ người, làm chủ ngữ ⇒ who.' },
        { stem: 'Today is ____ than yesterday.', options: ['hot', 'hottest', 'hotter', 'more hot'], answer: 2, explanation: 'So sánh hơn của "hot" ⇒ hotter.' },
        { stem: "Choose the synonym of 'happy'.", options: ['sad', 'glad', 'angry', 'tired'], answer: 1, explanation: 'happy = glad.' },
        { stem: 'I look forward to ____ you again.', options: ['see', 'seeing', 'saw', 'seen'], answer: 1, explanation: 'look forward to + V-ing.' },
        { stem: 'His ____ in the play was excellent. (perform)', options: ['perform', 'performer', 'performance', 'performed'], answer: 2, explanation: 'Cần danh từ ⇒ performance.' },
        { stem: 'Never ____ I seen such a beautiful view.', options: ['have', 'has', 'had', 'having'], answer: 0, explanation: 'Đảo ngữ với "Never" + present perfect ⇒ have.' },
        { stem: "Choose the antonym of 'expensive'.", options: ['cheap', 'costly', 'dear', 'pricey'], answer: 0, explanation: 'expensive ↔ cheap.' },
        { stem: 'Despite ____ tired, he kept working.', options: ['he was', 'being', 'be', 'was'], answer: 1, explanation: 'Despite + V-ing ⇒ being.' },
      ],
    },
    {
