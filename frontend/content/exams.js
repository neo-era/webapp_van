...
const EXAMS = {
  TOAN: [
    ...
    {
      examId: 'kt45-1', title: 'Kiểm tra 45′ #1 — Đạo hàm & Khảo sát hàm số', title_en: '45-min test #1 — Derivatives & Function analysis', durationMin: 45,
      questions: [
        { stem: 'Hàm số $y=x^3-3x^2$ đồng biến trên khoảng nào?', stem_en: 'On which interval is $y=x^3-3x^2$ increasing?', options: ['$(0;2)$', '$(-\\infty;0)$ và $(2;+\\infty)$', '$(2;+\\infty)$', '$\\mathbb{R}$'], options_en: ['$(0;2)$', '$(-\\infty;0)$ and $(2;+\\infty)$', '$(2;+\\infty)$', '$\\mathbb{R}$'], answer: 1, explanation: '$y\'=3x^2-6x=3x(x-2)>0\\Leftrightarrow x<0$ hoặc $x>2$.', explanation_en: '$y\'=3x^2-6x=3x(x-2)>0\\Leftrightarrow x<0$ or $x>2$.' },
        { stem: 'Giá trị cực đại của $y=-x^2+2x$ là?', stem_en: 'The maximum value of $y=-x^2+2x$ is?', options: ['$1$', '$2$', '$0$', '$-1$'], answer: 0, explanation: '$y\'=-2x+2=0\\Rightarrow x=1,\\ y(1)=1$.', explanation_en: '$y\'=-2x+2=0\\Rightarrow x=1,\\ y(1)=1$.' },
        { stem: 'Số điểm cực trị của $y=x^3+x$ là?', stem_en: 'The number of extrema of $y=x^3+x$ is?', options: ['$0$', '$1$', '$2$', '$3$'], answer: 0, explanation: '$y\'=3x^2+1>0\\ \\forall x$ ⇒ không có cực trị.', explanation_en: '$y\'=3x^2+1>0\\ \\forall x$ ⇒ no extrema.' },
        { stem: 'GTNN của $y=x^2-4x+5$ trên $\\mathbb{R}$ là?', stem_en: 'The minimum of $y=x^2-4x+5$ on $\\mathbb{R}$ is?', options: ['$1$', '$5$', '$0$', '$-1$'], answer: 0, explanation: '$y=(x-2)^2+1\\ge 1$.', explanation_en: '$y=(x-2)^2+1\\ge 1$.' },
        { stem: 'Tiệm cận đứng của $y=\\dfrac{x+1}{x-2}$ là?', stem_en: 'The vertical asymptote of $y=\\dfrac{x+1}{x-2}$ is?', options: ['$x=2$', '$y=2$', '$x=-1$', '$y=1$'], answer: 0, explanation: 'Mẫu $=0\\Leftrightarrow x=2$.', explanation_en: 'Denominator $=0\\Leftrightarrow x=2$.' },
        { stem: 'Hàm $y=x^4-2x^2+1$ có mấy điểm cực trị?', stem_en: 'How many extrema does $y=x^4-2x^2+1$ have?', options: ['$0$', '$1$', '$2$', '$3$'], answer: 3, explanation: '$y\'=4x^3-4x=4x(x-1)(x+1)$ có 3 nghiệm.', explanation_en: '$y\'=4x^3-4x=4x(x-1)(x+1)$ has 3 roots.' },
        { stem: 'Tiệm cận ngang của $y=\\dfrac{2x-3}{x+1}$ là?', stem_en: 'The horizontal asymptote of $y=\\dfrac{2x-3}{x+1}$ is?', options: ['$y=2$', '$x=-1$', '$y=-3$', '$x=2$'], answer: 0, explanation: '$\\lim\\limits_{x\\to\\pm\\infty}y=2$.', explanation_en: '$\\lim\\limits_{x\\to\\pm\\infty}y=2$.' },
        { stem: 'Hàm số $y=x^3$ đồng biến trên?', stem_en: 'The function $y=x^3$ is increasing on?', options: ['$(0;+\\infty)$', '$\\mathbb{R}$', '$(-\\infty;0)$', 'không khoảng nào'], options_en: ['$(0;+\\infty)$', '$\\mathbb{R}$', '$(-\\infty;0)$', 'no interval'], answer: 1, explanation: '$y\'=3x^2\\ge 0$, bằng 0 tại 1 điểm ⇒ đồng biến trên $\\mathbb{R}$.', explanation_en: '$y\'=3x^2\\ge 0$, zero at one point ⇒ increasing on $\\mathbb{R}$.' },
        { stem: 'Đạo hàm của $y=e^x$ là?', stem_en: 'The derivative of $y=e^x$ is?', options: ['$x e^{x-1}$', '$e^x$', '$\\dfrac{1}{x}$', '$x$'], answer: 1, explanation: '$(e^x)\'=e^x$.', explanation_en: '$(e^x)\'=e^x$.' },
        { stem: 'GTLN của $y=x^3-3x$ trên $[0;2]$ là?', stem_en: 'The maximum of $y=x^3-3x$ on $[0;2]$ is?', options: ['$0$', '$-2$', '$2$', '$6$'], answer: 2, explanation: '$y\'=3x^2-3=0\\Rightarrow x=1$; $y(0)=0, y(1)=-2, y(2)=2$.', explanation_en: '$y\'=3x^2-3=0\\Rightarrow x=1$; $y(0)=0, y(1)=-2, y(2)=2$.' },
      ],
    },
    {
      examId: 'kt45-2', title: 'Kiểm tra 45′ #2 — Nguyên hàm & Tích phân', title_en: '45-min test #2 — Antiderivatives & Integrals', durationMin: 45,
      questions: [
        { stem: 'Họ nguyên hàm $\\displaystyle\\int x^3\\,dx$ bằng?', stem_en: 'The antiderivative family $\\displaystyle\\int x^3\\,dx$ equals?', options: ['$\\dfrac{x^4}{4}+C$', '$3x^2+C$', '$x^4+C$', '$4x^3+C$'], answer: 0, explanation: '$\\int x^n dx=\\dfrac{x^{n+1}}{n+1}+C$.', explanation_en: '$\\int x^n dx=\\dfrac{x^{n+1}}{n+1}+C$.' },
        { stem: 'Tính $\\displaystyle\\int_0^1 x^2\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_0^1 x^2\\,dx$.', options: ['$\\dfrac{1}{3}$', '$1$', '$\\dfrac{1}{2}$', '$3$'], answer: 0, explanation: '$[x^3/3]_0^1=1/3$.', explanation_en: '$[x^3/3]_0^1=1/3$.' },
        { stem: '$\\displaystyle\\int \\dfrac{1}{x}\\,dx$ bằng?', stem_en: '$\\displaystyle\\int \\dfrac{1}{x}\\,dx$ equals?', options: ['$\\ln|x|+C$', '$-\\dfrac{1}{x^2}+C$', '$x+C$', '$\\dfrac{1}{x^2}$'], answer: 0, explanation: '$\\int\\frac{1}{x}dx=\\ln|x|+C$.', explanation_en: '$\\int\\frac{1}{x}dx=\\ln|x|+C$.' },
        { stem: 'Tính $\\displaystyle\\int_0^{\\pi}\\sin x\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_0^{\\pi}\\sin x\\,dx$.', options: ['$0$', '$1$', '$2$', '$-1$'], answer: 2, explanation: '$[-\\cos x]_0^\\pi=2$.', explanation_en: '$[-\\cos x]_0^\\pi=2$.' },
        { stem: '$\\displaystyle\\int e^x\\,dx$ bằng?', stem_en: '$\\displaystyle\\int e^x\\,dx$ equals?', options: ['$e^x+C$', '$xe^{x-1}$', '$\\ln x+C$', '$e^x$'], answer: 0, explanation: '$\\int e^x dx=e^x+C$.', explanation_en: '$\\int e^x dx=e^x+C$.' },
        { stem: 'Tính $\\displaystyle\\int_1^2 2x\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_1^2 2x\\,dx$.', options: ['$3$', '$4$', '$1$', '$2$'], answer: 0, explanation: '$[x^2]_1^2=3$.', explanation_en: '$[x^2]_1^2=3$.' },
        { stem: 'Diện tích hình phẳng giới hạn $y=x^2$, $Ox$, $x=0$, $x=3$ là?', stem_en: 'Area bounded by $y=x^2$, $Ox$, $x=0$, $x=3$ is?', options: ['$9$', '$3$', '$27$', '$6$'], answer: 0, explanation: '$\\int_0^3 x^2 dx=9$.', explanation_en: '$\\int_0^3 x^2 dx=9$.' },
        { stem: '$\\displaystyle\\int \\cos x\\,dx$ bằng?', stem_en: '$\\displaystyle\\int \\cos x\\,dx$ equals?', options: ['$\\sin x+C$', '$-\\sin x+C$', '$\\cos x$', '$-\\cos x+C$'], answer: 0, explanation: '$\\int\\cos x dx=\\sin x+C$.', explanation_en: '$\\int\\cos x dx=\\sin x+C$.' },
        { stem: 'Thể tích khối tròn xoay quay $y=x$ quanh $Ox$ từ $0$ đến $1$ là?', stem_en: 'Volume of revolution of $y=x$ about $Ox$ from $0$ to $1$ is?', options: ['$\\dfrac{\\pi}{3}$', '$\\pi$', '$\\dfrac{\\pi}{2}$', '$\\dfrac{2\\pi}{3}$'], answer: 0, explanation: '$V=\\pi\\int_0^1 x^2 dx=\\dfrac{\\pi}{3}$.', explanation_en: '$V=\\pi\\int_0^1 x^2 dx=\\dfrac{\\pi}{3}$.' },
        { stem: 'Tính $\\displaystyle\\int_0^1 (2x+1)\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_0^1 (2x+1)\\,dx$.', options: ['$2$', '$1$', '$3$', '$0$'], answer: 0, explanation: '$[x^2+x]_0^1=2$.', explanation_en: '$[x^2+x]_0^1=2$.' },
      ],
    },
    {
      examId: 'kt45-3', title: 'Kiểm tra 45′ #3 — Vectơ & tọa độ Oxyz', title_en: '45-min test #3 — Vectors & Oxyz coordinates', durationMin: 45,
      questions: [
        { stem: 'Cho $A(1;2;3)$, $B(3;0;1)$. Tọa độ $\\vec{AB}$ là?', stem_en: 'Given $A(1;2;3)$, $B(3;0;1)$. The coordinates of $\\vec{AB}$ are?', options: ['$(2;-2;-2)$', '$(-2;2;2)$', '$(4;2;4)$', '$(2;2;2)$'], answer: 0, explanation: '$\\vec{AB}=B-A=(2;-2;-2)$.', explanation_en: '$\\vec{AB}=B-A=(2;-2;-2)$.' },
        { stem: 'Độ dài của $\\vec{u}=(2;1;2)$ là?', stem_en: 'The length of $\\vec{u}=(2;1;2)$ is?', options: ['$3$', '$5$', '$9$', '$\\sqrt{5}$'], answer: 0, explanation: '$|\\vec{u}|=\\sqrt{4+1+4}=3$.', explanation_en: '$|\\vec{u}|=\\sqrt{4+1+4}=3$.' },
        { stem: 'Trung điểm của $A(0;0;0)$ và $B(2;4;6)$ là?', stem_en: 'The midpoint of $A(0;0;0)$ and $B(2;4;6)$ is?', options: ['$(1;2;3)$', '$(2;4;6)$', '$(1;1;1)$', '$(0;2;3)$'], answer: 0, explanation: 'Trung điểm $=\\left(\\tfrac{0+2}{2};\\tfrac{0+4}{2};\\tfrac{0+6}{2}\\right)$.', explanation_en: 'Midpoint $=\\left(\\tfrac{0+2}{2};\\tfrac{0+4}{2};\\tfrac{0+6}{2}\\right)$.' },
        { stem: 'Tích vô hướng $\\vec{u}\\cdot\\vec{v}$ với $\\vec{u}=(1;2;3)$, $\\vec{v}=(2;0;-1)$ là?', stem_en: 'The dot product $\\vec{u}\\cdot\\vec{v}$ with $\\vec{u}=(1;2;3)$, $\\vec{v}=(2;0;-1)$ is?', options: ['$-1$', '$5$', '$1$', '$2$'], answer: 0, explanation: '$2+0-3=-1$.', explanation_en: '$2+0-3=-1$.' },
        { stem: 'Vectơ nào vuông góc với $\\vec{u}=(2;1;2)$?', stem_en: 'Which vector is perpendicular to $\\vec{u}=(2;1;2)$?', options: ['$(1;-2;0)$', '$(1;1;1)$', '$(0;0;1)$', '$(1;0;1)$'], answer: 0, explanation: '$(2)(1)+(1)(-2)+(2)(0)=0$.', explanation_en: '$(2)(1)+(1)(-2)+(2)(0)=0$.' },
        { stem: 'Trọng tâm tam giác $A(1;1;1)$, $B(2;2;2)$, $C(3;3;3)$ là?', stem_en: 'The centroid of triangle $A(1;1;1)$, $B(2;2;2)$, $C(3;3;3)$ is?', options: ['$(2;2;2)$', '$(6;6;6)$', '$(1;1;1)$', '$(3;3;3)$'], answer: 0, explanation: '$G=\\left(\\tfrac{1+2+3}{3};\\dots\\right)=(2;2;2)$.', explanation_en: '$G=\\left(\\tfrac{1+2+3}{3};\\dots\\right)=(2;2;2)$.' },
        { stem: 'Góc giữa $\\vec{u}=(1;0;0)$ và $\\vec{v}=(0;1;0)$ là?', stem_en: 'The angle between $\\vec{u}=(1;0;0)$ and $\\vec{v}=(0;1;0)$ is?', options: ['$90^\\circ$', '$0^\\circ$', '$45^\\circ$', '$180^\\circ$'], answer: 0, explanation: '$\\vec{u}\\cdot\\vec{v}=0$.', explanation_en: '$\\vec{u}\\cdot\\vec{v}=0$.' },
        { stem: 'Điểm nào nằm trên trục $Ox$?', stem_en: 'Which point lies on the $Ox$ axis?', options: ['$(3;0;0)$', '$(0;3;0)$', '$(0;0;3)$', '$(1;1;1)$'], answer: 0, explanation: 'Trên $Ox$: $y=z=0$.', explanation_en: 'On $Ox$: $y=z=0$.' },
        { stem: 'Điểm đối xứng của $A(2;-1;0)$ qua gốc $O$ là?', stem_en: 'The point symmetric to $A(2;-1;0)$ through the origin $O$ is?', options: ['$(-2;1;0)$', '$(2;1;0)$', '$(-2;-1;0)$', '$(2;-1;0)$'], answer: 0, explanation: 'Đổi dấu các tọa độ.', explanation_en: 'Negate all coordinates.' },
        { stem: 'Hai vectơ $\\vec{u}=(1;1;1)$, $\\vec{v}=(2;2;2)$ có quan hệ gì?', stem_en: 'What is the relationship between $\\vec{u}=(1;1;1)$ and $\\vec{v}=(2;2;2)$?', options: ['Cùng phương ($\\vec{v}=2\\vec{u}$)', 'Vuông góc', 'Không cùng phương', 'Bằng nhau'], options_en: ['Collinear ($\\vec{v}=2\\vec{u}$)', 'Perpendicular', 'Not collinear', 'Equal'], answer: 0, explanation: '$\\vec{v}=2\\vec{u}$.', explanation_en: '$\\vec{v}=2\\vec{u}$.' },
      ],
    },
    {
      examId: 'kt45-4', title: 'Kiểm tra 45′ #4 — Mặt phẳng, đường thẳng, mặt cầu', title_en: '45-min test #4 — Planes, lines, spheres', durationMin: 45,
      questions: [
        { stem: 'Vectơ pháp tuyến của mặt phẳng $2x-3y+z-1=0$ là?', stem_en: 'A normal vector of the plane $2x-3y+z-1=0$ is?', options: ['$(2;-3;1)$', '$(2;3;1)$', '$(2;-3;-1)$', '$(-1;2;-3)$'], answer: 0, explanation: 'Hệ số của $x,y,z$.', explanation_en: 'The coefficients of $x,y,z$.' },
        { stem: 'Khoảng cách từ $O$ đến mặt phẳng $x+y+z-3=0$ là?', stem_en: 'Distance from $O$ to the plane $x+y+z-3=0$ is?', options: ['$\\sqrt{3}$', '$3$', '$1$', '$\\sqrt{2}$'], answer: 0, explanation: '$d=\\dfrac{|-3|}{\\sqrt{3}}=\\sqrt{3}$.', explanation_en: '$d=\\dfrac{|-3|}{\\sqrt{3}}=\\sqrt{3}$.' },
        { stem: 'Bán kính mặt cầu $(x-1)^2+(y+2)^2+z^2=9$ là?', stem_en: 'Radius of the sphere $(x-1)^2+(y+2)^2+z^2=9$ is?', options: ['$3$', '$9$', '$\\sqrt{3}$', '$1$'], answer: 0, explanation: '$R=\\sqrt{9}=3$.', explanation_en: '$R=\\sqrt{9}=3$.' },
        { stem: 'Tâm mặt cầu $x^2+y^2+z^2-2x-4y+1=0$ là?', stem_en: 'Center of the sphere $x^2+y^2+z^2-2x-4y+1=0$ is?', options: ['$(1;2;0)$', '$(-1;-2;0)$', '$(2;4;0)$', '$(1;2;1)$'], answer: 0, explanation: '$I(a;b;c)$ với $a=1,b=2,c=0$.', explanation_en: '$I(a;b;c)$ with $a=1,b=2,c=0$.' },
        { stem: 'Vectơ chỉ phương của $d:\\dfrac{x-1}{2}=\\dfrac{y}{-1}=\\dfrac{z+2}{3}$ là?', stem_en: 'A direction vector of $d:\\dfrac{x-1}{2}=\\dfrac{y}{-1}=\\dfrac{z+2}{3}$ is?', options: ['$(2;-1;3)$', '$(1;0;-2)$', '$(2;1;3)$', '$(-2;1;3)$'], answer: 0, explanation: 'Mẫu số là tọa độ VTCP.', explanation_en: 'The denominators give the direction-vector coordinates.' },
        { stem: 'Mặt phẳng qua $O$ với pháp tuyến $(1;2;2)$ có phương trình?', stem_en: 'The plane through $O$ with normal $(1;2;2)$ has equation?', options: ['$x+2y+2z=0$', '$x+2y+2z-1=0$', '$2x+y+2z=0$', '$x+y+z=0$'], answer: 0, explanation: 'Qua $O$ ⇒ $D=0$.', explanation_en: 'Through $O$ ⇒ $D=0$.' },
        { stem: 'Điểm $M(1;1;1)$ có thuộc mặt phẳng $x+y+z-3=0$ không?', stem_en: 'Does point $M(1;1;1)$ lie on the plane $x+y+z-3=0$?', options: ['Có', 'Không', 'Không xác định', 'Chỉ khi đổi dấu'], options_en: ['Yes', 'No', 'Undetermined', 'Only if signs change'], answer: 0, explanation: '$1+1+1-3=0$.', explanation_en: '$1+1+1-3=0$.' },
        { stem: 'Khoảng cách từ $M(1;0;0)$ đến mặt phẳng $2x+2y+z+4=0$ là?', stem_en: 'Distance from $M(1;0;0)$ to the plane $2x+2y+z+4=0$ is?', options: ['$2$', '$6$', '$3$', '$1$'], answer: 0, explanation: '$\\dfrac{|2+0+0+4|}{\\sqrt{4+4+1}}=\\dfrac{6}{3}=2$.', explanation_en: '$\\dfrac{|2+0+0+4|}{\\sqrt{4+4+1}}=\\dfrac{6}{3}=2$.' },
        { stem: 'Bán kính mặt cầu $x^2+y^2+z^2=16$ là?', stem_en: 'Radius of the sphere $x^2+y^2+z^2=16$ is?', options: ['$4$', '$16$', '$8$', '$2$'], answer: 0, explanation: '$R=\\sqrt{16}=4$.', explanation_en: '$R=\\sqrt{16}=4$.' },
        { stem: 'Vectơ pháp tuyến của mặt phẳng $3x-4z+5=0$ là?', stem_en: 'A normal vector of the plane $3x-4z+5=0$ is?', options: ['$(3;0;-4)$', '$(3;-4;0)$', '$(3;-4;5)$', '$(3;0;4)$'], answer: 0, explanation: 'Thiếu $y$ ⇒ hệ số $y=0$.', explanation_en: 'No $y$ term ⇒ coefficient of $y=0$.' },
      ],
    },
    {
      examId: 'kt45-5', title: 'Kiểm tra 45′ #5 — Xác suất có điều kiện & Thống kê', title_en: '45-min test #5 — Conditional probability & Statistics', durationMin: 45,
      questions: [
        { stem: 'Cho $P(A\\cap B)=0{,}2$, $P(B)=0{,}4$. Tính $P(A\\mid B)$.', stem_en: 'Given $P(A\\cap B)=0{,}2$, $P(B)=0{,}4$. Find $P(A\\mid B)$.', options: ['$0{,}5$', '$0{,}8$', '$0{,}08$', '$0{,}2$'], answer: 0, explanation: '$\\dfrac{0{,}2}{0{,}4}=0{,}5$.', explanation_en: '$\\dfrac{0{,}2}{0{,}4}=0{,}5$.' },
        { stem: '$A,B$ độc lập, $P(A)=0{,}3$, $P(B)=0{,}5$. Tính $P(A\\cap B)$.', stem_en: '$A,B$ independent, $P(A)=0{,}3$, $P(B)=0{,}5$. Find $P(A\\cap B)$.', options: ['$0{,}15$', '$0{,}8$', '$0{,}2$', '$0{,}5$'], answer: 0, explanation: '$P(A)P(B)=0{,}15$.', explanation_en: '$P(A)P(B)=0{,}15$.' },
        { stem: 'Khoảng biến thiên của mẫu $2,5,9,12$ là?', stem_en: 'The range of the sample $2,5,9,12$ is?', options: ['$10$', '$7$', '$2$', '$12$'], answer: 0, explanation: '$12-2=10$.', explanation_en: '$12-2=10$.' },
        { stem: 'Gieo một xúc xắc. Xác suất "số chẵn" biết "số $\\ge 3$" là?', stem_en: 'Roll a die. P("even" given "number $\\ge 3$") is?', options: ['$\\dfrac{1}{2}$', '$\\dfrac{1}{3}$', '$\\dfrac{1}{4}$', '$\\dfrac{2}{3}$'], answer: 0, explanation: '$B=\\{3,4,5,6\\}, A\\cap B=\\{4,6\\}\\Rightarrow 2/4$.', explanation_en: '$B=\\{3,4,5,6\\}, A\\cap B=\\{4,6\\}\\Rightarrow 2/4$.' },
        { stem: 'Phương sai và độ lệch chuẩn đo đại lượng nào?', stem_en: 'What do variance and standard deviation measure?', options: ['Độ phân tán của dữ liệu', 'Giá trị trung bình', 'Giá trị lớn nhất', 'Trung vị'], options_en: ['The spread of the data', 'The mean', 'The maximum', 'The median'], answer: 0, explanation: 'Đo mức độ phân tán quanh trung bình.', explanation_en: 'They measure the spread around the mean.' },
        { stem: 'Phương sai của mẫu $4,4,4,4$ là?', stem_en: 'The variance of the sample $4,4,4,4$ is?', options: ['$0$', '$4$', '$16$', '$1$'], answer: 0, explanation: 'Mọi giá trị bằng trung bình ⇒ phương sai $=0$.', explanation_en: 'All values equal the mean ⇒ variance $=0$.' },
        { stem: 'Cho $P(A\\cap B)=0{,}1$, $P(A\\mid B)=0{,}5$. Tính $P(B)$.', stem_en: 'Given $P(A\\cap B)=0{,}1$, $P(A\\mid B)=0{,}5$. Find $P(B)$.', options: ['$0{,}2$', '$0{,}05$', '$0{,}5$', '$0{,}6$'], answer: 0, explanation: '$P(B)=\\dfrac{0{,}1}{0{,}5}=0{,}2$.', explanation_en: '$P(B)=\\dfrac{0{,}1}{0{,}5}=0{,}2$.' },
        { stem: 'Khoảng tứ phân vị $\\Delta_Q$ của mẫu $1,3,5,7,9$ là?', stem_en: 'The interquartile range $\\Delta_Q$ of the sample $1,3,5,7,9$ is?', options: ['$6$', '$4$', '$8$', '$2$'], answer: 0, explanation: '$Q_1=2, Q_3=8 \\Rightarrow \\Delta_Q=6$.', explanation_en: '$Q_1=2, Q_3=8 \\Rightarrow \\Delta_Q=6$.' },
        { stem: 'Nếu $P(A\\mid B)=P(A)$ thì hai biến cố $A,B$?', stem_en: 'If $P(A\\mid B)=P(A)$, then events $A,B$ are?', options: ['Độc lập', 'Xung khắc', 'Đối nhau', 'Bằng nhau'], options_en: ['Independent', 'Mutually exclusive', 'Complementary', 'Equal'], answer: 0, explanation: 'Định nghĩa biến cố độc lập.', explanation_en: 'Definition of independent events.' },
        { stem: 'Độ lệch chuẩn $s$ bằng?', stem_en: 'The standard deviation $s$ equals?', options: ['Căn bậc hai của phương sai', 'Bình phương phương sai', 'Trung bình', 'Phương sai'], options_en: ['The square root of the variance', 'The square of the variance', 'The mean', 'The variance'], answer: 0, explanation: '$s=\\sqrt{s^2}$.', explanation_en: '$s=\\sqrt{s^2}$.' },
      ],
    },
    {
    ...
    {
      examId: 'toan-thptqg-1', title: '🎯 Đề thi thử THPT QG — Toán (theo cấu trúc, 90 phút)', title_en: '🎯 National HS mock exam — Mathematics (90 min)', durationMin: 90,
      questions: [
        { stem: 'Hàm số $y=x^3-3x+1$ có bao nhiêu điểm cực trị?', stem_en: 'How many extrema does $y=x^3-3x+1$ have?', options: ['$1$', '$2$', '$3$', '$0$'], answer: 1, explanation: '$y\'=3x^2-3=0\\Rightarrow x=\\pm1$ ⇒ 2 cực trị.', explanation_en: '$y\'=3x^2-3=0\\Rightarrow x=\\pm1$ ⇒ 2 extrema.' },
        { stem: 'Tập xác định của $y=\\ln(x-2)$ là?', stem_en: 'The domain of $y=\\ln(x-2)$ is?', options: ['$\\mathbb{R}\\setminus\\{2\\}$', '$(-\\infty;2)$', '$(2;+\\infty)$', '$[2;+\\infty)$'], answer: 2, explanation: 'Điều kiện $x-2>0\\Rightarrow x>2$.', explanation_en: 'Condition $x-2>0\\Rightarrow x>2$.' },
        { stem: 'Tính $\\displaystyle\\int (2x+1)\\,dx$.', stem_en: 'Compute $\\displaystyle\\int (2x+1)\\,dx$.', options: ['$x^2+x+C$', '$2x^2+x+C$', '$x^2+C$', '$x^2+2x+C$'], answer: 0, explanation: '$\\int(2x+1)dx=x^2+x+C$.', explanation_en: '$\\int(2x+1)dx=x^2+x+C$.' },
        { stem: 'Nghiệm của phương trình $2^x=8$ là?', stem_en: 'The solution of $2^x=8$ is?', options: ['$2$', '$4$', '$8$', '$3$'], answer: 3, explanation: '$2^x=2^3\\Rightarrow x=3$.', explanation_en: '$2^x=2^3\\Rightarrow x=3$.' },
        { stem: 'Đạo hàm của $y=e^{2x}$ là?', stem_en: 'The derivative of $y=e^{2x}$ is?', options: ['$e^{2x}$', '$2xe^{2x}$', '$2e^{2x}$', '$\\tfrac12 e^{2x}$'], answer: 2, explanation: '$(e^{2x})\'=2e^{2x}$.', explanation_en: '$(e^{2x})\'=2e^{2x}$.' },
        { stem: 'Mặt phẳng $(P): 2x-y+2z-3=0$ có một vectơ pháp tuyến là?', stem_en: 'A normal vector of the plane $(P): 2x-y+2z-3=0$ is?', options: ['$(2;1;2)$', '$(2;-1;2)$', '$(-1;2;2)$', '$(2;-1;-3)$'], answer: 1, explanation: 'Hệ số của $x,y,z$ là $(2;-1;2)$.', explanation_en: 'The coefficients of $x,y,z$ are $(2;-1;2)$.' },
        { stem: 'Khoảng cách từ gốc $O$ đến mặt phẳng $2x-2y+z+6=0$?', stem_en: 'Distance from origin $O$ to the plane $2x-2y+z+6=0$?', options: ['$3$', '$6$', '$2$', '$1$'], answer: 2, explanation: '$d=\\dfrac{|6|}{\\sqrt{4+4+1}}=\\dfrac{6}{3}=2$.', explanation_en: '$d=\\dfrac{|6|}{\\sqrt{4+4+1}}=\\dfrac{6}{3}=2$.' },
        { stem: 'Tính $\\displaystyle\\int_0^1 e^x\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_0^1 e^x\\,dx$.', options: ['$e$', '$e+1$', '$1-e$', '$e-1$'], answer: 3, explanation: '$[e^x]_0^1=e-1$.', explanation_en: '$[e^x]_0^1=e-1$.' },
        { stem: 'Tiệm cận ngang của đồ thị $y=\\dfrac{2x-1}{x+1}$ là?', stem_en: 'The horizontal asymptote of $y=\\dfrac{2x-1}{x+1}$ is?', options: ['$y=2$', '$y=1$', '$y=-1$', '$y=\\tfrac12$'], answer: 0, explanation: 'Bậc tử = bậc mẫu ⇒ TCN $y=\\dfrac{2}{1}=2$.', explanation_en: 'Equal degrees ⇒ HA $y=\\dfrac{2}{1}=2$.' },
        { stem: 'Thể tích khối tròn xoay khi quay $y=x$ ($0\\le x\\le1$) quanh $Ox$?', stem_en: 'Volume of revolution of $y=x$ ($0\\le x\\le1$) about $Ox$?', options: ['$\\pi$', '$\\dfrac{\\pi}{3}$', '$\\dfrac{\\pi}{2}$', '$\\dfrac{2\\pi}{3}$'], answer: 1, explanation: '$V=\\pi\\int_0^1 x^2dx=\\dfrac{\\pi}{3}$.', explanation_en: '$V=\\pi\\int_0^1 x^2dx=\\dfrac{\\pi}{3}$.' },
        { stem: 'Gieo một con xúc xắc cân đối. Xác suất xuất hiện mặt có số chấm là số nguyên tố ($2,3,5$)?', stem_en: 'Roll a fair die. Probability the number of dots is prime ($2,3,5$)?', options: ['$\\tfrac13$', '$\\tfrac23$', '$\\tfrac16$', '$\\tfrac12$'], answer: 3, explanation: '3 kết quả thuận lợi / 6 ⇒ $\\tfrac12$.', explanation_en: '3 favorable outcomes / 6 ⇒ $\\tfrac12$.' },
        { stem: 'Giá trị $\\log_2 8 + \\log_2 2$ bằng?', stem_en: 'The value of $\\log_2 8 + \\log_2 2$?', options: ['$4$', '$3$', '$5$', '$16$'], answer: 0, explanation: '$3+1=4$.', explanation_en: '$3+1=4$.' },
        { stem: 'GTLN của $y=-x^2+4x-1$ trên $\\mathbb{R}$?', stem_en: 'Maximum of $y=-x^2+4x-1$ on $\\mathbb{R}$?', options: ['$4$', '$3$', '$-1$', '$2$'], answer: 1, explanation: '$y=-(x-2)^2+3\\le3$.', explanation_en: '$y=-(x-2)^2+3\\le3$.' },
        { stem: 'Số trung bình cộng của mẫu $2,4,6,8,10$?', stem_en: 'The mean of the sample $2,4,6,8,10$?', options: ['$5$', '$7$', '$6$', '$8$'], answer: 2, explanation: '$\\dfrac{30}{5}=6$.', explanation_en: '$\\dfrac{30}{5}=6$.' },
        { stem: 'Họ nguyên hàm của $\\cos x$ là?', stem_en: 'The antiderivatives of $\\cos x$ are?', options: ['$\\sin x+C$', '$-\\sin x+C$', '$\\cos x+C$', '$-\\cos x+C$'], answer: 0, explanation: '$\\int\\cos x\\,dx=\\sin x+C$.', explanation_en: '$\\int\\cos x\\,dx=\\sin x+C$.' },
      ],
    },
    {
      examId: 'toan-hsg-1', title: '🏆 Đề thi HSG — Toán 12 (150 phút)', title_en: '🏆 Gifted-student exam — Mathematics 12 (150 min)', durationMin: 150,
      questions: [
        { stem: 'Cho $a+b+c=0$. Khi đó $a^3+b^3+c^3$ bằng?', stem_en: 'Given $a+b+c=0$. Then $a^3+b^3+c^3$ equals?', options: ['$0$', '$3abc$', '$abc$', '$-3abc$'], answer: 1, explanation: 'Khi $a+b+c=0$ thì $a^3+b^3+c^3=3abc$.', explanation_en: 'When $a+b+c=0$, $a^3+b^3+c^3=3abc$.' },
        { stem: 'GTNN của $f(x)=x+\\dfrac{1}{x}$ với $x>0$?', stem_en: 'Minimum of $f(x)=x+\\dfrac{1}{x}$ for $x>0$?', options: ['$2$', '$1$', '$0$', '$4$'], answer: 0, explanation: 'AM–GM: $x+\\tfrac1x\\ge2$, dấu "=" khi $x=1$.', explanation_en: 'AM–GM: $x+\\tfrac1x\\ge2$, equality at $x=1$.' },
        { stem: 'Số nghiệm nguyên dương của $xy=x+y$?', stem_en: 'Number of positive-integer solutions of $xy=x+y$?', options: ['vô số', '$0$', '$1$', '$2$'], options_en: ['infinitely many', '$0$', '$1$', '$2$'], answer: 2, explanation: '$(x-1)(y-1)=1\\Rightarrow x=y=2$ ⇒ đúng 1 nghiệm.', explanation_en: '$(x-1)(y-1)=1\\Rightarrow x=y=2$ ⇒ exactly one solution.' },
        { stem: 'Với mọi số nguyên $n$, $n^3-n$ luôn chia hết cho?', stem_en: 'For every integer $n$, $n^3-n$ is always divisible by?', options: ['$4$', '$5$', '$7$', '$6$'], answer: 3, explanation: '$n^3-n=(n-1)n(n+1)$ — tích 3 số liên tiếp ⇒ chia hết cho 6.', explanation_en: '$n^3-n=(n-1)n(n+1)$ — product of 3 consecutive integers ⇒ divisible by 6.' },
        { stem: 'GTNN của $g(x)=x^2-6x+11$?', stem_en: 'Minimum of $g(x)=x^2-6x+11$?', options: ['$3$', '$2$', '$1$', '$-2$'], answer: 1, explanation: '$g=(x-3)^2+2\\ge2$.', explanation_en: '$g=(x-3)^2+2\\ge2$.' },
        { stem: 'Số dư khi chia $2^{100}$ cho $3$?', stem_en: 'Remainder of $2^{100}$ when divided by $3$?', options: ['$0$', '$2$', '$1$', 'không xác định'], options_en: ['$0$', '$2$', '$1$', 'undefined'], answer: 2, explanation: '$2\\equiv-1\\Rightarrow 2^{100}\\equiv1\\ (\\text{mod }3)$.', explanation_en: '$2\\equiv-1\\Rightarrow 2^{100}\\equiv1\\ (\\text{mod }3)$.' },
        { stem: 'Phân tích $x^4+4$ thành tích hai tam thức bậc hai, một thừa số là?', stem_en: 'Factor $x^4+4$ into two quadratics; one factor is?', options: ['$x^2+4$', '$x^2+2x+2$', '$x^2-4$', '$x^2+x+2$'], answer: 1, explanation: '$x^4+4=(x^2-2x+2)(x^2+2x+2)$.', explanation_en: '$x^4+4=(x^2-2x+2)(x^2+2x+2)$.' },
        { stem: '$\\triangle ABC$ có $AB=6, AC=4$, phân giác trong $AD$ ($D\\in BC$). Tỉ số $\\dfrac{BD}{DC}$?', stem_en: '$\\triangle ABC$ with $AB=6, AC=4$, internal bisector $AD$ ($D\\in BC$). Ratio $\\dfrac{BD}{DC}$?', options: ['$\\tfrac23$', '$\\tfrac43$', '$\\tfrac32$', '$1$'], answer: 2, explanation: '$\\dfrac{BD}{DC}=\\dfrac{AB}{AC}=\\dfrac{6}{4}=\\dfrac32$.', explanation_en: '$\\dfrac{BD}{DC}=\\dfrac{AB}{AC}=\\dfrac{6}{4}=\\dfrac32$.' },
        { stem: 'Với $a,b>0$, giá trị nhỏ nhất của $(a+b)\\left(\\dfrac1a+\\dfrac1b\\right)$?', stem_en: 'For $a,b>0$, the minimum of $(a+b)\\left(\\dfrac1a+\\dfrac1b\\right)$?', options: ['$4$', '$3$', '$2$', '$1$'], answer: 0, explanation: '$=2+\\dfrac ab+\\dfrac ba\\ge4$.', explanation_en: '$=2+\\dfrac ab+\\dfrac ba\\ge4$.' },
        { stem: 'Với $a,b,c>0$: $\\dfrac ab+\\dfrac bc+\\dfrac ca \\ge$ ?', stem_en: 'For $a,b,c>0$: $\\dfrac ab+\\dfrac bc+\\dfrac ca \\ge$ ?', options: ['$1$', '$2$', '$3$', '$4$'], answer: 2, explanation: 'AM–GM ba số ⇒ $\\ge3\\sqrt[3]{1}=3$.', explanation_en: 'AM–GM of three terms ⇒ $\\ge3\\sqrt[3]{1}=3$.' },
      ],
    },
    {
      examId: 'toan-bank-1', title: 'Luyện tập — Khảo sát hàm số & Mũ–Logarit', title_en: 'Practice — Function analysis & Exponentials/Logarithms', durationMin: 45,
      questions: [
        { stem: 'Hàm số $y=x^3-3x^2$ đồng biến trên khoảng nào?', stem_en: 'On which interval is the function $y=x^3-3x^2$ increasing?', options: ['$(2;+\\infty)$', '$(0;2)$', '$(-\\infty;0)$', '$(0;+\\infty)$'], answer: 0, explanation: "$y'=3x^2-6x>0\\Leftrightarrow x<0$ hoặc $x>2$.", explanation_en: "$y'=3x^2-6x>0\\Leftrightarrow x<0$ or $x>2$." },
        { stem: 'Số tiệm cận đứng của đồ thị $y=\\dfrac{1}{x-1}$?', stem_en: 'How many vertical asymptotes does $y=\\dfrac{1}{x-1}$ have?', options: ['$0$', '$1$', '$2$', '$3$'], answer: 1, explanation: 'Mẫu $=0$ tại $x=1$ ⇒ 1 tiệm cận đứng.', explanation_en: 'Denominator $=0$ at $x=1$ ⇒ one vertical asymptote.' },
        { stem: 'Giá trị cực đại của $y=-x^2+2x+3$?', stem_en: 'The maximum value of $y=-x^2+2x+3$?', options: ['$3$', '$1$', '$4$', '$5$'], answer: 2, explanation: '$y=-(x-1)^2+4\\le4$, cực đại $=4$.', explanation_en: '$y=-(x-1)^2+4\\le4$, maximum $=4$.' },
        { stem: 'Tính $\\log_3 27$.', stem_en: 'Compute $\\log_3 27$.', options: ['$2$', '$9$', '$27$', '$3$'], answer: 3, explanation: '$\\log_3 3^3=3$.', explanation_en: '$\\log_3 3^3=3$.' },
        { stem: 'Đạo hàm của $y=\\ln(2x)$?', stem_en: 'Derivative of $y=\\ln(2x)$?', options: ['$\\dfrac1x$', '$\\dfrac2x$', '$\\dfrac1{2x}$', '$\\ln 2$'], answer: 0, explanation: '$(\\ln 2x)\'=\\dfrac{2}{2x}=\\dfrac1x$.', explanation_en: '$(\\ln 2x)\'=\\dfrac{2}{2x}=\\dfrac1x$.' },
        { stem: 'Nghiệm của $2^x=\\dfrac18$?', stem_en: 'Solve $2^x=\\dfrac18$.', options: ['$3$', '$-3$', '$-2$', '$8$'], answer: 1, explanation: '$2^x=2^{-3}\\Rightarrow x=-3$.', explanation_en: '$2^x=2^{-3}\\Rightarrow x=-3$.' },
        { stem: 'Hàm số $y=x^4-2x^2$ có bao nhiêu điểm cực trị?', stem_en: 'How many extrema does $y=x^4-2x^2$ have?', options: ['$1$', '$2$', '$3$', '$0$'], answer: 2, explanation: "$y'=4x(x^2-1)=0\\Rightarrow x=0,\\pm1$ ⇒ 3 cực trị.", explanation_en: "$y'=4x(x^2-1)=0\\Rightarrow x=0,\\pm1$ ⇒ 3 extrema." },
        { stem: 'GTNN của $y=x+\\dfrac4x$ với $x>0$?', stem_en: 'Minimum of $y=x+\\dfrac4x$ for $x>0$?', options: ['$2$', '$8$', '$1$', '$4$'], answer: 3, explanation: 'AM–GM: $\\ge2\\sqrt4=4$, dấu "=" khi $x=2$.', explanation_en: 'AM–GM: $\\ge2\\sqrt4=4$, equality at $x=2$.' },
        { stem: 'Tiệm cận ngang của $y=\\dfrac{x+1}{x-2}$?', stem_en: 'Horizontal asymptote of $y=\\dfrac{x+1}{x-2}$?', options: ['$y=1$', '$y=-1$', '$y=2$', '$y=\\tfrac12$'], answer: 0, explanation: 'Bậc tử = bậc mẫu ⇒ TCN $y=1$.', explanation_en: 'Equal degrees ⇒ horizontal asymptote $y=1$.' },
        { stem: 'Tính $\\log_2 8-\\log_2 2$.', stem_en: 'Compute $\\log_2 8-\\log_2 2$.', options: ['$1$', '$2$', '$3$', '$4$'], answer: 1, explanation: '$3-1=2$.', explanation_en: '$3-1=2$.' },
      ],
    },
    {
      examId: 'toan-bank-2', title: 'Luyện tập — Tích phân & Hình Oxyz', title_en: 'Practice — Integrals & Coordinate geometry (Oxyz)', durationMin: 45,
      questions: [
        { stem: 'Tính $\\displaystyle\\int_0^1 3x^2\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_0^1 3x^2\\,dx$.', options: ['$1$', '$3$', '$2$', '$\\tfrac13$'], answer: 0, explanation: '$[x^3]_0^1=1$.', explanation_en: '$[x^3]_0^1=1$.' },
        { stem: 'Tìm $\\displaystyle\\int \\dfrac{dx}{x}$.', stem_en: 'Find $\\displaystyle\\int \\dfrac{dx}{x}$.', options: ['$-\\dfrac1{x^2}+C$', '$\\ln|x|+C$', '$x\\ln x+C$', '$\\dfrac1{x^2}+C$'], answer: 1, explanation: '$\\int\\dfrac{dx}{x}=\\ln|x|+C$.', explanation_en: '$\\int\\dfrac{dx}{x}=\\ln|x|+C$.' },
        { stem: 'Khoảng cách từ $O$ đến mặt phẳng $x+2y+2z-6=0$?', stem_en: 'Distance from $O$ to the plane $x+2y+2z-6=0$?', options: ['$1$', '$3$', '$2$', '$6$'], answer: 2, explanation: '$\\dfrac{|-6|}{\\sqrt{1+4+4}}=2$.', explanation_en: '$\\dfrac{|-6|}{\\sqrt{1+4+4}}=2$.' },
        { stem: 'Bán kính mặt cầu $x^2+y^2+z^2-4x=0$?', stem_en: 'Radius of the sphere $x^2+y^2+z^2-4x=0$?', options: ['$1$', '$4$', '$\\sqrt2$', '$2$'], answer: 3, explanation: '$(x-2)^2+y^2+z^2=4\\Rightarrow R=2$.', explanation_en: '$(x-2)^2+y^2+z^2=4\\Rightarrow R=2$.' },
        { stem: 'Tính $\\displaystyle\\int_0^\\pi \\sin x\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_0^\\pi \\sin x\\,dx$.', options: ['$2$', '$0$', '$1$', '$-2$'], answer: 0, explanation: '$[-\\cos x]_0^\\pi=1+1=2$.', explanation_en: '$[-\\cos x]_0^\\pi=1+1=2$.' },
        { stem: 'Vectơ pháp tuyến của mặt phẳng $2x-3y+z-1=0$?', stem_en: 'A normal vector of the plane $2x-3y+z-1=0$?', options: ['$(2;3;1)$', '$(2;-3;1)$', '$(-3;1;2)$', '$(2;-3;-1)$'], answer: 1, explanation: 'Hệ số $(2;-3;1)$.', explanation_en: 'Coefficients $(2;-3;1)$.' },
        { stem: 'Tìm $\\displaystyle\\int e^{2x}\\,dx$.', stem_en: 'Find $\\displaystyle\\int e^{2x}\\,dx$.', options: ['$e^{2x}+C$', '$2e^{2x}+C$', '$\\tfrac12 e^{2x}+C$', '$\\dfrac{e^{2x}}{x}+C$'], answer: 2, explanation: '$\\int e^{2x}dx=\\tfrac12 e^{2x}+C$.', explanation_en: '$\\int e^{2x}dx=\\tfrac12 e^{2x}+C$.' },
        { stem: 'Diện tích hình phẳng giới hạn bởi $y=x^2$ và $y=2x$?', stem_en: 'Area of the region bounded by $y=x^2$ and $y=2x$?', options: ['$\\tfrac23$', '$2$', '$\\tfrac83$', '$\\tfrac43$'], answer: 3, explanation: '$\\int_0^2(2x-x^2)dx=4-\\tfrac83=\\tfrac43$.', explanation_en: '$\\int_0^2(2x-x^2)dx=4-\\tfrac83=\\tfrac43$.' },
        { stem: 'Trung điểm của $A(2;0;4)$ và $B(0;2;0)$?', stem_en: 'Midpoint of $A(2;0;4)$ and $B(0;2;0)$?', options: ['$(1;1;2)$', '$(2;2;4)$', '$(1;1;0)$', '$(2;1;2)$'], answer: 0, explanation: 'Trung bình từng tọa độ $\\Rightarrow(1;1;2)$.', explanation_en: 'Average each coordinate $\\Rightarrow(1;1;2)$.' },
        { stem: 'Tính $\\displaystyle\\int_1^2 2x\\,dx$.', stem_en: 'Compute $\\displaystyle\\int_1^2 2x\\,dx$.', options: ['$2$', '$4$', '$3$', '$1$'], answer: 2, explanation: '$[x^2]_1^2=4-1=3$.', explanation_en: '$[x^2]_1^2=4-1=3$.' },
      ],
    },
    {
      examId: 'toan-bank-3', title: 'Luyện tập — Tổ hợp, Xác suất & Thống kê', title_en: 'Practice — Combinatorics, Probability & Statistics', durationMin: 45,
      questions: [
        { stem: 'Tính $C_6^2$.', stem_en: 'Compute $C_6^2$.', options: ['$15$', '$30$', '$12$', '$36$'], answer: 0, explanation: '$\\dfrac{6!}{2!4!}=15$.', explanation_en: '$\\dfrac{6!}{2!4!}=15$.' },
        { stem: 'Gieo hai con xúc xắc, xác suất tổng số chấm bằng $7$?', stem_en: 'Rolling two dice, probability the sum equals $7$?', options: ['$\\tfrac15$', '$\\tfrac16$', '$\\tfrac1{12}$', '$\\tfrac19$'], answer: 1, explanation: '$6$ cách $/36=\\tfrac16$.', explanation_en: '$6$ ways $/36=\\tfrac16$.' },
        { stem: 'Số trung bình cộng của $4,6,8,10$?', stem_en: 'The mean of $4,6,8,10$?', options: ['$6$', '$8$', '$7$', '$9$'], answer: 2, explanation: '$\\dfrac{28}{4}=7$.', explanation_en: '$\\dfrac{28}{4}=7$.' },
        { stem: 'Hai biến cố độc lập $P(A)=0{,}3$, $P(B)=0{,}4$. Tính $P(A\\cap B)$.', stem_en: 'Independent events $P(A)=0{,}3$, $P(B)=0{,}4$. Find $P(A\\cap B)$.', options: ['$0{,}7$', '$0{,}1$', '$0{,}5$', '$0{,}12$'], answer: 3, explanation: '$0{,}3\\cdot0{,}4=0{,}12$.', explanation_en: '$0{,}3\\cdot0{,}4=0{,}12$.' },
        { stem: 'Số hoán vị của $4$ phần tử khác nhau?', stem_en: 'Number of permutations of $4$ distinct elements?', options: ['$24$', '$12$', '$16$', '$4$'], answer: 0, explanation: '$4!=24$.', explanation_en: '$4!=24$.' },
        { stem: 'Cho $P(A\\cap B)=0{,}2$, $P(B)=0{,}5$. Tính $P(A\\mid B)$.', stem_en: 'Given $P(A\\cap B)=0{,}2$, $P(B)=0{,}5$. Find $P(A\\mid B)$.', options: ['$0{,}1$', '$0{,}4$', '$0{,}25$', '$0{,}7$'], answer: 1, explanation: '$\\dfrac{0{,}2}{0{,}5}=0{,}4$.', explanation_en: '$\\dfrac{0{,}2}{0{,}5}=0{,}4$.' },
        { stem: 'Phương sai của mẫu $2,2,2,2$?', stem_en: 'Variance of the sample $2,2,2,2$?', options: ['$2$', '$1$', '$0$', '$4$'], answer: 2, explanation: 'Mọi giá trị bằng nhau ⇒ phương sai $=0$.', explanation_en: 'All values equal ⇒ variance $=0$.' },
        { stem: 'Số cách xếp $3$ người vào $3$ ghế?', stem_en: 'Number of ways to seat $3$ people in $3$ seats?', options: ['$3$', '$9$', '$1$', '$6$'], answer: 3, explanation: '$3!=6$.', explanation_en: '$3!=6$.' },
        { stem: 'Giá trị $C_n^0$ bằng?', stem_en: 'The value of $C_n^0$?', options: ['$1$', '$n$', '$0$', '$n!$'], answer: 0, explanation: '$C_n^0=1$.', explanation_en: '$C_n^0=1$.' },
        { stem: 'Gieo đồng xu cân đối $2$ lần, xác suất được $2$ mặt ngửa?', stem_en: 'Tossing a fair coin twice, probability of two heads?', options: ['$\\tfrac12$', '$\\tfrac14$', '$\\tfrac13$', '$\\tfrac34$'], answer: 1, explanation: '$\\tfrac12\\cdot\\tfrac12=\\tfrac14$.', explanation_en: '$\\tfrac12\\cdot\\tfrac12=\\tfrac14$.' },
      ],
    },
  ],
  ...
  LY: [
    {
      examId: 'ly-kt45-1', title: 'Kiểm tra 45′ #1 — Vật lí nhiệt & Khí lí tưởng', title_en: '45-min test #1 — Thermal physics & Ideal gas', durationMin: 45,
      questions: [
        { stem: 'Định luật I Nhiệt động lực học: $\\Delta U=$?', stem_en: 'First law of thermodynamics: $\\Delta U=$?', options: ['$Q-A$', '$A+Q$', '$A-Q$', '$AQ$'], answer: 1, explanation: '$\\Delta U=A+Q$.', explanation_en: '$\\Delta U=A+Q$.' },
        { stem: 'Đun $1$ kg nước ($c=4200$) tăng $5$ °C cần nhiệt lượng?', stem_en: 'Heating $1$ kg of water ($c=4200$) by $5$ °C needs how much heat?', options: ['$4200$ J', '$21000$ J', '$1000$ J', '$84000$ J'], answer: 1, explanation: '$Q=mc\\Delta t=1\\cdot4200\\cdot5=21000$ J.', explanation_en: '$Q=mc\\Delta t=1\\cdot4200\\cdot5=21000$ J.' },
        { stem: 'Đơn vị của nội năng là?', stem_en: 'The unit of internal energy is?', options: ['Niutơn (N)', 'Oát (W)', 'Jun (J)', 'Paxcan (Pa)'], options_en: ['Newton (N)', 'Watt (W)', 'Joule (J)', 'Pascal (Pa)'], answer: 2, explanation: 'Nội năng đo bằng jun.', explanation_en: 'Internal energy is measured in joules.' },
        { stem: 'Khí đẳng nhiệt $p_1=2$, $V_1=3$, nén còn $V_2=1$. Tính $p_2$.', stem_en: 'Isothermal gas $p_1=2$, $V_1=3$, compressed to $V_2=1$. Find $p_2$.', options: ['$2$', '$3$', '$6$', '$1$'], answer: 2, explanation: '$p_2=\\dfrac{p_1V_1}{V_2}=6$.', explanation_en: '$p_2=\\dfrac{p_1V_1}{V_2}=6$.' },
        { stem: '$27$ °C bằng bao nhiêu Kelvin?', stem_en: '$27$ °C equals how many Kelvin?', options: ['$27$', '$300$', '$246$', '$273$'], answer: 1, explanation: '$T=27+273=300$ K.', explanation_en: '$T=27+273=300$ K.' },
        { stem: 'Đẳng tích: $p_1=1$ atm ở $T_1=300$ K, đun tới $T_2=600$ K. Tính $p_2$.', stem_en: 'Isochoric: $p_1=1$ atm at $T_1=300$ K, heated to $T_2=600$ K. Find $p_2$.', options: ['$1$', '$2$', '$0{,}5$', '$4$'], answer: 1, explanation: '$\\dfrac{p}{T}$ const ⇒ $p_2=2$ atm.', explanation_en: '$\\dfrac{p}{T}$ const ⇒ $p_2=2$ atm.' },
        { stem: 'Trong định luật I, $Q>0$ nghĩa là?', stem_en: 'In the first law, $Q>0$ means?', options: ['hệ tỏa nhiệt', 'hệ nhận nhiệt', 'hệ sinh công', 'nội năng không đổi'], options_en: ['the system releases heat', 'the system absorbs heat', 'the system does work', 'internal energy unchanged'], answer: 1, explanation: 'Quy ước $Q>0$: nhận nhiệt.', explanation_en: 'Convention $Q>0$: heat absorbed.' },
        { stem: 'Phương trình trạng thái khí lí tưởng: $\\dfrac{p_1V_1}{T_1}=$?', stem_en: 'Ideal-gas equation of state: $\\dfrac{p_1V_1}{T_1}=$?', options: ['$p_2V_2T_2$', '$\\dfrac{T_2}{p_2V_2}$', '$\\dfrac{p_2V_2}{T_2}$', '$p_2+V_2$'], answer: 2, explanation: '$\\dfrac{p_1V_1}{T_1}=\\dfrac{p_2V_2}{T_2}$.', explanation_en: '$\\dfrac{p_1V_1}{T_1}=\\dfrac{p_2V_2}{T_2}$.' },
        { stem: 'Đơn vị nhiệt dung riêng là?', stem_en: 'The unit of specific heat capacity is?', options: ['J', 'J/kg', 'J/(kg·K)', 'W/K'], answer: 2, explanation: '$c$ đo bằng J/(kg·K).', explanation_en: '$c$ is measured in J/(kg·K).' },
        { stem: 'Khi khí sinh công thì công $A$?', stem_en: 'When a gas does work, the work $A$?', options: ['$A>0$', '$A=0$', '$A<0$', '$A=Q$'], answer: 2, explanation: 'Hệ sinh công ⇒ $A<0$.', explanation_en: 'The system does work ⇒ $A<0$.' },
      ],
    },
    {
      examId: 'ly-kt45-2', title: 'Kiểm tra 45′ #2 — Từ trường & Hạt nhân', title_en: '45-min test #2 — Magnetism & Nuclear physics', durationMin: 45,
      questions: [
        { stem: 'Lực từ lên dây ($B=0{,}2$ T, $I=3$ A, $l=0{,}5$ m, vuông góc) là?', stem_en: 'Magnetic force on a wire ($B=0{,}2$ T, $I=3$ A, $l=0{,}5$ m, perpendicular) is?', options: ['$0{,}3$ N', '$0{,}1$ N', '$3$ N', '$0{,}6$ N'], answer: 0, explanation: '$F=BIl=0{,}2\\cdot3\\cdot0{,}5=0{,}3$ N.', explanation_en: '$F=BIl=0{,}2\\cdot3\\cdot0{,}5=0{,}3$ N.' },
        { stem: 'Đơn vị của cảm ứng từ $B$ là?', stem_en: 'The unit of magnetic flux density $B$ is?', options: ['Vêbe (Wb)', 'Tesla (T)', 'Henry (H)', 'Jun (J)'], options_en: ['Weber (Wb)', 'Tesla (T)', 'Henry (H)', 'Joule (J)'], answer: 1, explanation: '$B$ đo bằng tesla.', explanation_en: '$B$ is measured in tesla.' },
        { stem: 'Từ thông qua khung $N=5$ vòng, $B=0{,}4$ T, $S=0{,}02$ m², $\\alpha=0$?', stem_en: 'Magnetic flux through a coil $N=5$ turns, $B=0{,}4$ T, $S=0{,}02$ m², $\\alpha=0$?', options: ['$0{,}4$', '$0{,}04$', '$0{,}004$', '$4$'], answer: 1, explanation: '$\\Phi=NBS=5\\cdot0{,}4\\cdot0{,}02=0{,}04$ Wb.', explanation_en: '$\\Phi=NBS=5\\cdot0{,}4\\cdot0{,}02=0{,}04$ Wb.' },
        { stem: 'Từ thông biến thiên $0{,}1$ Wb trong $0{,}5$ s. Suất điện động cảm ứng?', stem_en: 'Flux changes by $0{,}1$ Wb in $0{,}5$ s. The induced EMF?', options: ['$0{,}05$ V', '$0{,}5$ V', '$0{,}2$ V', '$2$ V'], answer: 2, explanation: '$|e|=\\dfrac{0{,}1}{0{,}5}=0{,}2$ V.', explanation_en: '$|e|=\\dfrac{0{,}1}{0{,}5}=0{,}2$ V.' },
        { stem: 'Hạt nhân $^{4}_{2}He$ có bao nhiêu neutron?', stem_en: 'How many neutrons does $^{4}_{2}He$ have?', options: ['$4$', '$2$', '$6$', '$0$'], answer: 1, explanation: '$N=A-Z=4-2=2$.', explanation_en: '$N=A-Z=4-2=2$.' },
        { stem: 'Năng lượng liên kết của hạt nhân tính bằng?', stem_en: 'The binding energy of a nucleus is given by?', options: ['$\\Delta m\\,c$', '$\\Delta m\\,c^2$', '$mc^2$', '$\\dfrac{\\Delta m}{c^2}$'], answer: 1, explanation: '$W_{lk}=\\Delta m\\,c^2$.', explanation_en: '$W_{lk}=\\Delta m\\,c^2$.' },
        { stem: 'Sau một chu kì bán rã, số hạt nhân còn lại bằng?', stem_en: 'After one half-life, the number of nuclei remaining is?', options: ['$100\\%$', '$50\\%$', '$25\\%$', '$0\\%$'], answer: 1, explanation: '$N=N_0/2$.', explanation_en: '$N=N_0/2$.' },
        { stem: '$1$ u tương đương xấp xỉ?', stem_en: '$1$ u is approximately equivalent to?', options: ['$931{,}5$ MeV/$c^2$', '$1$ MeV', '$3\\cdot10^8$ m/s', '$9{,}1\\cdot10^{-31}$ kg'], answer: 0, explanation: '$1\\,u\\approx931{,}5$ MeV/$c^2$.', explanation_en: '$1\\,u\\approx931{,}5$ MeV/$c^2$.' },
        { stem: 'Lực Lorentz lên hạt điện tích là?', stem_en: 'The Lorentz force on a charged particle is?', options: ['$qvB$ (luôn vậy)', '$|q|vB\\sin\\alpha$', '$BIl$', '$qE$'], options_en: ['$qvB$ (always)', '$|q|vB\\sin\\alpha$', '$BIl$', '$qE$'], answer: 1, explanation: '$f=|q|vB\\sin\\alpha$.', explanation_en: '$f=|q|vB\\sin\\alpha$.' },
        { stem: 'Định luật phóng xạ có dạng?', stem_en: 'The radioactive decay law has the form?', options: ['$N=N_0 2^{t/T}$', '$N=N_0 e^{\\lambda t}$', '$N=N_0 2^{-t/T}$', '$N=N_0 t$'], answer: 2, explanation: '$N=N_0 2^{-t/T}=N_0 e^{-\\lambda t}$.', explanation_en: '$N=N_0 2^{-t/T}=N_0 e^{-\\lambda t}$.' },
      ],
    },
    {
    ...
    {
      examId: 'ly-thptqg-1', title: '🎯 Đề thi thử THPT QG — Vật lí (theo cấu trúc, 50 phút)', title_en: '🎯 National HS mock exam — Physics (50 min)', durationMin: 50,
      questions: [
        { stem: 'Đổi $27$ °C sang thang Kelvin?', stem_en: 'Convert $27$ °C to the Kelvin scale?', options: ['$273$ K', '$327$ K', '$246$ K', '$300$ K'], answer: 3, explanation: '$27+273=300$ K.', explanation_en: '$27+273=300$ K.' },
        { stem: 'Nén đẳng nhiệt khí từ $p_1=2$ atm, $V_1=4$ L về $V_2=2$ L. Áp suất $p_2$?', stem_en: 'Isothermal compression from $p_1=2$ atm, $V_1=4$ L to $V_2=2$ L. Pressure $p_2$?', options: ['$2$ atm', '$8$ atm', '$4$ atm', '$1$ atm'], answer: 2, explanation: '$p_1V_1=p_2V_2\\Rightarrow p_2=\\dfrac{2\\cdot4}{2}=4$ atm.', explanation_en: '$p_1V_1=p_2V_2\\Rightarrow p_2=\\dfrac{2\\cdot4}{2}=4$ atm.' },
        { stem: 'Lực từ lên dây dẫn $l=0{,}5$ m mang $I=5$ A vuông góc $B=0{,}2$ T?', stem_en: 'Magnetic force on a wire $l=0{,}5$ m carrying $I=5$ A perpendicular to $B=0{,}2$ T?', options: ['$0{,}5$ N', '$0{,}2$ N', '$1$ N', '$5$ N'], answer: 0, explanation: '$F=BIl=0{,}2\\cdot5\\cdot0{,}5=0{,}5$ N.', explanation_en: '$F=BIl=0{,}2\\cdot5\\cdot0{,}5=0{,}5$ N.' },
        { stem: 'Sau $3$ chu kì bán rã, lượng chất phóng xạ còn lại?', stem_en: 'After $3$ half-lives, the fraction of radioactive material remaining?', options: ['$\\tfrac12$', '$\\tfrac14$', '$\\tfrac18$', '$\\tfrac1{16}$'], answer: 2, explanation: '$2^{-3}=\\tfrac18$.', explanation_en: '$2^{-3}=\\tfrac18$.' },
        { stem: 'Đơn vị của cảm ứng từ là?', stem_en: 'The unit of magnetic flux density is?', options: ['Vôn', 'Tesla', 'Ampe', 'Oát'], options_en: ['Volt', 'Tesla', 'Ampere', 'Watt'], answer: 1, explanation: 'Cảm ứng từ $B$ đo bằng Tesla (T).', explanation_en: 'Magnetic flux density $B$ is measured in Tesla (T).' },
        { stem: 'Nhiệt lượng để đun $2$ kg nước tăng $10^\\circ C$ ($c=4200$)?', stem_en: 'Heat to warm $2$ kg of water by $10^\\circ C$ ($c=4200$)?', options: ['$42000$ J', '$8400$ J', '$84000$ J', '$420000$ J'], answer: 2, explanation: '$Q=mc\\Delta t=2\\cdot4200\\cdot10=84000$ J.', explanation_en: '$Q=mc\\Delta t=2\\cdot4200\\cdot10=84000$ J.' },
        { stem: 'Số neutron trong hạt nhân $^{14}_{6}C$?', stem_en: 'Number of neutrons in the nucleus $^{14}_{6}C$?', options: ['$6$', '$8$', '$14$', '$20$'], answer: 1, explanation: '$N=14-6=8$.', explanation_en: '$N=14-6=8$.' },
        { stem: 'Đun đẳng tích khí từ $T_1=300$ K, $p_1=1$ atm đến $T_2=600$ K. $p_2$?', stem_en: 'Isochoric heating from $T_1=300$ K, $p_1=1$ atm to $T_2=600$ K. $p_2$?', options: ['$1$ atm', '$3$ atm', '$2$ atm', '$0{,}5$ atm'], answer: 2, explanation: '$\\dfrac{p_1}{T_1}=\\dfrac{p_2}{T_2}\\Rightarrow p_2=2$ atm.', explanation_en: '$\\dfrac{p_1}{T_1}=\\dfrac{p_2}{T_2}\\Rightarrow p_2=2$ atm.' },
        { stem: 'Hạt nhân có năng lượng liên kết riêng càng lớn thì?', stem_en: 'A nucleus with larger binding energy per nucleon is?', options: ['càng kém bền', 'càng bền vững', 'càng dễ phóng xạ', 'không đổi'], options_en: ['less stable', 'more stable', 'more radioactive', 'unchanged'], answer: 1, explanation: 'Năng lượng liên kết riêng lớn ⇒ hạt nhân bền vững.', explanation_en: 'Larger binding energy per nucleon ⇒ more stable nucleus.' },
        { stem: 'Thiết bị tiêu thụ công $A=2000$ J trong $t=4$ s có công suất?', stem_en: 'Power of a device consuming work $A=2000$ J in $t=4$ s?', options: ['$8000$ W', '$500$ W', '$2000$ W', '$250$ W'], answer: 1, explanation: '$P=A/t=2000/4=500$ W.', explanation_en: '$P=A/t=2000/4=500$ W.' },
        { stem: 'Lực Lorentz tác dụng lên hạt mang điện đứng yên ($v=0$)?', stem_en: 'Lorentz force on a charged particle at rest ($v=0$)?', options: ['$0$', '$qB$', '$qvB$', 'cực đại'], options_en: ['$0$', '$qB$', '$qvB$', 'maximum'], answer: 0, explanation: '$f=qvB\\sin\\theta=0$ khi $v=0$.', explanation_en: '$f=qvB\\sin\\theta=0$ when $v=0$.' },
        { stem: 'Khí nhận nhiệt $Q=200$ J và nhận công $A=100$ J. Độ biến thiên nội năng?', stem_en: 'A gas receives heat $Q=200$ J and work $A=100$ J. Change in internal energy?', options: ['$100$ J', '$200$ J', '$300$ J', '$-100$ J'], answer: 2, explanation: '$\\Delta U=Q+A=300$ J.', explanation_en: '$\\Delta U=Q+A=300$ J.' },
      ],
    },
    {
      examId: 'ly-hsg-1', title: '🏆 Đề thi HSG — Vật lí 12 (150 phút)', title_en: '🏆 Gifted-student exam — Physics 12 (150 min)', durationMin: 150,
      questions: [
        { stem: 'Hạt nhân $^{235}_{92}U$ có bao nhiêu neutron?', stem_en: 'How many neutrons does the nucleus $^{235}_{92}U$ have?', options: ['$143$', '$92$', '$235$', '$327$'], answer: 0, explanation: '$N=235-92=143$.', explanation_en: '$N=235-92=143$.' },
        { stem: 'Độ hụt khối $\\Delta m=0{,}1\\,u$. Năng lượng liên kết (MeV)?', stem_en: 'Mass defect $\\Delta m=0{,}1\\,u$. Binding energy (MeV)?', options: ['$9{,}315$', '$93{,}15$', '$931{,}5$', '$0{,}9315$'], answer: 1, explanation: '$E=0{,}1\\cdot931{,}5=93{,}15$ MeV.', explanation_en: '$E=0{,}1\\cdot931{,}5=93{,}15$ MeV.' },
        { stem: 'Đẳng áp: $V_1=2$ L ở $T_1=300$ K. Thể tích ở $T_2=600$ K?', stem_en: 'Isobaric: $V_1=2$ L at $T_1=300$ K. Volume at $T_2=600$ K?', options: ['$2$ L', '$3$ L', '$4$ L', '$6$ L'], answer: 2, explanation: '$\\dfrac{V_1}{T_1}=\\dfrac{V_2}{T_2}\\Rightarrow V_2=4$ L.', explanation_en: '$\\dfrac{V_1}{T_1}=\\dfrac{V_2}{T_2}\\Rightarrow V_2=4$ L.' },
        { stem: 'Lực Lorentz: $q=1{,}6\\cdot10^{-19}$ C, $v=2\\cdot10^6$ m/s vuông góc $B=0{,}5$ T?', stem_en: 'Lorentz force: $q=1{,}6\\cdot10^{-19}$ C, $v=2\\cdot10^6$ m/s perpendicular to $B=0{,}5$ T?', options: ['$1{,}6\\cdot10^{-14}$ N', '$1{,}6\\cdot10^{-13}$ N', '$3{,}2\\cdot10^{-13}$ N', '$8\\cdot10^{-14}$ N'], answer: 1, explanation: '$f=qvB=1{,}6\\cdot10^{-19}\\cdot2\\cdot10^6\\cdot0{,}5=1{,}6\\cdot10^{-13}$ N.', explanation_en: '$f=qvB=1{,}6\\cdot10^{-19}\\cdot2\\cdot10^6\\cdot0{,}5=1{,}6\\cdot10^{-13}$ N.' },
        { stem: 'Sau bao nhiêu chu kì bán rã thì còn $6{,}25\\%$ lượng ban đầu?', stem_en: 'After how many half-lives is $6{,}25\\%$ of the original amount left?', options: ['$3$', '$5$', '$6$', '$4$'], answer: 3, explanation: '$6{,}25\\%=\\tfrac1{16}=2^{-4}$ ⇒ 4 chu kì.', explanation_en: '$6{,}25\\%=\\tfrac1{16}=2^{-4}$ ⇒ 4 half-lives.' },
        { stem: 'Hiệu suất động cơ nhiệt nhận $Q=1000$ J, sinh công $A=300$ J?', stem_en: 'Efficiency of a heat engine taking $Q=1000$ J and producing work $A=300$ J?', options: ['$40\\%$', '$30\\%$', '$33\\%$', '$70\\%$'], answer: 1, explanation: '$H=A/Q=300/1000=30\\%$.', explanation_en: '$H=A/Q=300/1000=30\\%$.' },
        { stem: 'Cảm ứng từ cách dòng điện thẳng $I=10$ A một khoảng $r=0{,}05$ m?', stem_en: 'Magnetic flux density at distance $r=0{,}05$ m from a straight current $I=10$ A?', options: ['$2\\cdot10^{-5}$ T', '$8\\cdot10^{-5}$ T', '$4\\cdot10^{-5}$ T', '$10^{-5}$ T'], answer: 2, explanation: '$B=2\\cdot10^{-7}\\cdot\\dfrac{10}{0{,}05}=4\\cdot10^{-5}$ T.', explanation_en: '$B=2\\cdot10^{-7}\\cdot\\dfrac{10}{0{,}05}=4\\cdot10^{-5}$ T.' },
        { stem: 'Phản ứng hạt nhân tỏa năng lượng khi tổng khối lượng các hạt sau phản ứng?', stem_en: 'A nuclear reaction releases energy when the total mass of the products is?', options: ['lớn hơn trước', 'nhỏ hơn trước', 'bằng trước', 'không liên quan'], options_en: ['greater than before', 'less than before', 'equal to before', 'unrelated'], answer: 1, explanation: 'Khối lượng giảm ⇒ năng lượng tỏa ra theo $E=\\Delta m c^2$.', explanation_en: 'Mass decreases ⇒ energy is released per $E=\\Delta m c^2$.' },
        { stem: 'Công khí thực hiện khi đẳng áp $p=10^5$ Pa, $\\Delta V=0{,}002$ m³?', stem_en: 'Work done by the gas in an isobaric process $p=10^5$ Pa, $\\Delta V=0{,}002$ m³?', options: ['$100$ J', '$2000$ J', '$200$ J', '$20$ J'], answer: 2, explanation: '$A=p\\Delta V=10^5\\cdot0{,}002=200$ J.', explanation_en: '$A=p\\Delta V=10^5\\cdot0{,}002=200$ J.' },
        { stem: 'Nhiệt lượng đun $1$ kg nước từ $20^\\circ C$ đến $100^\\circ C$ ($c=4200$)?', stem_en: 'Heat to warm $1$ kg of water from $20^\\circ C$ to $100^\\circ C$ ($c=4200$)?', options: ['$168000$ J', '$33600$ J', '$336000$ J', '$420000$ J'], answer: 2, explanation: '$Q=1\\cdot4200\\cdot80=336000$ J.', explanation_en: '$Q=1\\cdot4200\\cdot80=336000$ J.' },
      ],
    },
  ],
  ...
  HOA: [
    ...
    {
      examId: 'hoa-thptqg-1', title: '🎯 Đề thi thử THPT QG — Hóa học (theo cấu trúc, 50 phút)', title_en: '🎯 National HS mock exam — Chemistry (50 min)', durationMin: 50,
      questions: [
        { stem: 'Số mol trong $8$ g NaOH ($M=40$)?', stem_en: 'Number of moles in $8$ g NaOH ($M=40$)?', options: ['$0{,}1$', '$0{,}2$', '$0{,}4$', '$0{,}8$'], answer: 1, explanation: '$n=8/40=0{,}2$ mol.', explanation_en: '$n=8/40=0{,}2$ mol.' },
        { stem: 'Thủy phân ester đơn chức trong NaOH theo tỉ lệ mol ester : NaOH là?', stem_en: 'Hydrolysis of a monoester in NaOH has the ester : NaOH mole ratio of?', options: ['$1:1$', '$1:2$', '$2:1$', '$1:3$'], answer: 0, explanation: '$RCOOR\'+NaOH\\to RCOONa+R\'OH$ ⇒ 1 : 1.', explanation_en: '$RCOOR\'+NaOH\\to RCOONa+R\'OH$ ⇒ 1 : 1.' },
        { stem: 'Công thức phân tử của glucose là?', stem_en: 'The molecular formula of glucose is?', options: ['$C_{12}H_{22}O_{11}$', '$C_6H_{12}O_6$', '$C_6H_{10}O_5$', '$CH_2O$'], answer: 1, explanation: 'Glucose là $C_6H_{12}O_6$.', explanation_en: 'Glucose is $C_6H_{12}O_6$.' },
        { stem: 'Kim loại nào sau đây KHÔNG tác dụng với dung dịch HCl?', stem_en: 'Which metal does NOT react with HCl solution?', options: ['Fe', 'Zn', 'Mg', 'Cu'], answer: 3, explanation: 'Cu đứng sau H trong dãy điện hóa.', explanation_en: 'Cu is after H in the activity series.' },
        { stem: 'Phần trăm khối lượng H trong $H_2O$ ($M=18$)?', stem_en: 'Mass percent of H in $H_2O$ ($M=18$)?', options: ['$11{,}1\\%$', '$88{,}9\\%$', '$50\\%$', '$8\\%$'], answer: 0, explanation: '$2/18\\cdot100\\%\\approx11{,}1\\%$.', explanation_en: '$2/18\\cdot100\\%\\approx11{,}1\\%$.' },
        { stem: 'Polime nào được điều chế từ etilen?', stem_en: 'Which polymer is made from ethylene?', options: ['PVC', 'PS', 'PE', 'cao su buna'], options_en: ['PVC', 'PS', 'PE', 'Buna rubber'], answer: 2, explanation: 'PE $(-CH_2-CH_2-)_n$ từ etilen $C_2H_4$.', explanation_en: 'PE $(-CH_2-CH_2-)_n$ from ethylene $C_2H_4$.' },
        { stem: 'Số mol $H_2$ sinh ra khi $0{,}1$ mol Zn tác dụng HCl dư?', stem_en: 'Moles of $H_2$ produced when $0{,}1$ mol Zn reacts with excess HCl?', options: ['$0{,}05$', '$0{,}1$', '$0{,}2$', '$0{,}3$'], answer: 1, explanation: '$Zn+2HCl\\to ZnCl_2+H_2$ ⇒ $n_{H_2}=0{,}1$.', explanation_en: '$Zn+2HCl\\to ZnCl_2+H_2$ ⇒ $n_{H_2}=0{,}1$.' },
        { stem: 'Amino acid trong phân tử có các nhóm chức nào?', stem_en: 'Which functional groups are present in an amino acid molecule?', options: ['chỉ $-NH_2$', 'chỉ $-COOH$', '$-NH_2$ và $-COOH$', 'chỉ $-OH$'], options_en: ['only $-NH_2$', 'only $-COOH$', '$-NH_2$ and $-COOH$', 'only $-OH$'], answer: 2, explanation: 'Có cả nhóm amino và carboxyl ⇒ tính lưỡng tính.', explanation_en: 'Has both amino and carboxyl groups ⇒ amphoteric.' },
        { stem: 'Nhiệt phân $CaCO_3$ thu được CaO và khí gì?', stem_en: 'Thermal decomposition of $CaCO_3$ gives CaO and which gas?', options: ['$O_2$', '$CO_2$', '$H_2O$', '$CO$'], answer: 1, explanation: '$CaCO_3\\to CaO+CO_2$.', explanation_en: '$CaCO_3\\to CaO+CO_2$.' },
        { stem: 'Khối lượng mol của $CH_3COOH$?', stem_en: 'Molar mass of $CH_3COOH$?', options: ['$46$', '$74$', '$60$', '$32$'], answer: 2, explanation: '$C_2H_4O_2=24+4+32=60$ g/mol.', explanation_en: '$C_2H_4O_2=24+4+32=60$ g/mol.' },
        { stem: 'Phản ứng ester hóa giữa acid và ancol thuộc loại?', stem_en: 'The esterification between an acid and an alcohol is which type of reaction?', options: ['một chiều', 'thuận nghịch', 'trao đổi', 'oxi hóa – khử'], options_en: ['one-way', 'reversible', 'exchange', 'redox'], answer: 1, explanation: 'Phản ứng ester hóa là thuận nghịch.', explanation_en: 'Esterification is reversible.' },
        { stem: 'Kim loại nào dẫn điện tốt nhất?', stem_en: 'Which metal conducts electricity best?', options: ['Cu', 'Ag', 'Au', 'Al'], answer: 1, explanation: 'Bạc (Ag) dẫn điện tốt nhất.', explanation_en: 'Silver (Ag) is the best electrical conductor.' },
      ],
    },
    {
      examId: 'hoa-hsg-1', title: '🏆 Đề thi HSG — Hóa học 12 (150 phút)', title_en: '🏆 Gifted-student exam — Chemistry 12 (150 min)', durationMin: 150,
      questions: [
        { stem: 'Xà phòng hóa $8{,}8$ g $CH_3COOC_2H_5$ ($M=88$) thu được muối $CH_3COONa$ ($M=82$) bao nhiêu gam?', stem_en: 'Saponifying $8{,}8$ g $CH_3COOC_2H_5$ ($M=88$) yields how many grams of $CH_3COONa$ ($M=82$)?', options: ['$8{,}2$', '$8{,}8$', '$4{,}1$', '$16{,}4$'], answer: 0, explanation: '$n=0{,}1\\Rightarrow m=0{,}1\\cdot82=8{,}2$ g.', explanation_en: '$n=0{,}1\\Rightarrow m=0{,}1\\cdot82=8{,}2$ g.' },
        { stem: 'Cho $5{,}6$ g Fe vào $CuSO_4$ dư. Khối lượng Cu sinh ra?', stem_en: 'Add $5{,}6$ g Fe to excess $CuSO_4$. Mass of Cu formed?', options: ['$5{,}6$ g', '$6{,}4$ g', '$3{,}2$ g', '$12{,}8$ g'], answer: 1, explanation: '$n_{Fe}=0{,}1\\Rightarrow m_{Cu}=0{,}1\\cdot64=6{,}4$ g.', explanation_en: '$n_{Fe}=0{,}1\\Rightarrow m_{Cu}=0{,}1\\cdot64=6{,}4$ g.' },
        { stem: 'Số mắt xích của PVC có $M=62500$ (monome $M=62{,}5$)?', stem_en: 'Number of repeat units of PVC with $M=62500$ (monomer $M=62{,}5$)?', options: ['$500$', '$2000$', '$1000$', '$100$'], answer: 2, explanation: '$n=62500/62{,}5=1000$.', explanation_en: '$n=62500/62{,}5=1000$.' },
        { stem: 'Đốt cháy hoàn toàn ester no, đơn chức, mạch hở thì:', stem_en: 'Complete combustion of a saturated, monofunctional, open-chain ester gives:', options: ['$n_{CO_2}>n_{H_2O}$', '$n_{CO_2}=n_{H_2O}$', '$n_{CO_2}<n_{H_2O}$', 'không xác định'], options_en: ['$n_{CO_2}>n_{H_2O}$', '$n_{CO_2}=n_{H_2O}$', '$n_{CO_2}<n_{H_2O}$', 'undefined'], answer: 1, explanation: 'Ester no đơn chức hở ⇒ $n_{CO_2}=n_{H_2O}$.', explanation_en: 'Saturated open-chain monoester ⇒ $n_{CO_2}=n_{H_2O}$.' },
        { stem: 'Glyxin $H_2N\\text{-}CH_2\\text{-}COOH$ tác dụng được với?', stem_en: 'Glycine $H_2N\\text{-}CH_2\\text{-}COOH$ reacts with?', options: ['chỉ HCl', 'chỉ NaOH', 'cả HCl và NaOH', 'không chất nào'], options_en: ['only HCl', 'only NaOH', 'both HCl and NaOH', 'neither'], answer: 2, explanation: 'Tính lưỡng tính ⇒ phản ứng cả acid và base.', explanation_en: 'Amphoteric ⇒ reacts with both acid and base.' },
        { stem: 'Cho $0{,}2$ mol Zn vào $CuSO_4$ dư. Khối lượng Cu thu được?', stem_en: 'Add $0{,}2$ mol Zn to excess $CuSO_4$. Mass of Cu obtained?', options: ['$6{,}4$ g', '$3{,}2$ g', '$12{,}8$ g', '$25{,}6$ g'], answer: 2, explanation: '$n_{Cu}=0{,}2\\Rightarrow m=12{,}8$ g.', explanation_en: '$n_{Cu}=0{,}2\\Rightarrow m=12{,}8$ g.' },
        { stem: 'Phần trăm khối lượng C trong $CH_4$ ($M=16$)?', stem_en: 'Mass percent of C in $CH_4$ ($M=16$)?', options: ['$25\\%$', '$80\\%$', '$75\\%$', '$50\\%$'], answer: 2, explanation: '$12/16\\cdot100\\%=75\\%$.', explanation_en: '$12/16\\cdot100\\%=75\\%$.' },
        { stem: 'Số đồng phân amine bậc một ứng với $C_3H_9N$?', stem_en: 'Number of primary-amine isomers of $C_3H_9N$?', options: ['$1$', '$3$', '$4$', '$2$'], answer: 3, explanation: '$CH_3CH_2CH_2NH_2$ và $(CH_3)_2CHNH_2$ ⇒ 2 đồng phân.', explanation_en: '$CH_3CH_2CH_2NH_2$ and $(CH_3)_2CHNH_2$ ⇒ 2 isomers.' },
        { stem: 'Xà phòng hóa chất béo (trieste của glycerol) thu được?', stem_en: 'Saponifying a fat (triester of glycerol) gives?', options: ['glucose', 'glycerol và muối của acid béo', 'ethanol', 'tinh bột'], options_en: ['glucose', 'glycerol and fatty-acid salts', 'ethanol', 'starch'], answer: 1, explanation: 'Sản phẩm là glycerol và xà phòng (muối acid béo).', explanation_en: 'The products are glycerol and soap (fatty-acid salts).' },
        { stem: 'Cho $0{,}1$ mol Fe tác dụng HCl dư. Thể tích $H_2$ (đktc)?', stem_en: 'React $0{,}1$ mol Fe with excess HCl. Volume of $H_2$ (STP)?', options: ['$1{,}12$ L', '$2{,}24$ L', '$3{,}36$ L', '$4{,}48$ L'], answer: 1, explanation: '$Fe+2HCl\\to FeCl_2+H_2$ ⇒ $V=0{,}1\\cdot22{,}4=2{,}24$ L.', explanation_en: '$Fe+2HCl\\to FeCl_2+H_2$ ⇒ $V=0{,}1\\cdot22{,}4=2{,}24$ L.' },
      ],
    },
  ],
  ...
  ANH: [
    ...
    {
      examId: 'anh-thptqg-1', title: '🎯 Đề thi thử THPT QG — Tiếng Anh (theo cấu trúc, 50 phút)', title_en: '🎯 National HS mock exam — English (50 min)', durationMin: 50,
      questions: [
        { stem: 'She ____ to school every day.', options: ['go', 'goes', 'going', 'went'], answer: 1, explanation: 'Hiện tại đơn, ngôi 3 số ít ⇒ goes.', explanation_en: 'Present simple, 3rd person singular ⇒ goes.' },
        { stem: 'This song ____ by many young people.', options: ['sings', 'sang', 'is sung', 'sung'], answer: 2, explanation: 'Bị động hiện tại đơn ⇒ is sung.', explanation_en: 'Present simple passive ⇒ is sung.' },
        { stem: 'If I ____ rich, I would travel around the world.', options: ['am', 'was', 'were', 'will be'], answer: 2, explanation: 'Điều kiện loại 2 ⇒ were.', explanation_en: 'Second conditional ⇒ were.' },
        { stem: 'He said he ____ tired.', options: ['is', 'will', 'be', 'was'], answer: 3, explanation: 'Tường thuật lùi thì: is → was.', explanation_en: 'Reported speech backshift: is → was.' },
        { stem: 'The man ____ helped me is my neighbour.', options: ['which', 'whose', 'who', 'where'], answer: 2, explanation: 'Chỉ người, làm chủ ngữ ⇒ who.', explanation_en: 'Refers to a person as subject ⇒ who.' },
        { stem: 'Today is ____ than yesterday.', options: ['hot', 'hottest', 'hotter', 'more hot'], answer: 2, explanation: 'So sánh hơn của "hot" ⇒ hotter.', explanation_en: 'Comparative of "hot" ⇒ hotter.' },
        { stem: "Choose the synonym of 'happy'.", options: ['sad', 'glad', 'angry', 'tired'], answer: 1, explanation: 'happy = glad.', explanation_en: 'happy = glad.' },
        { stem: 'I look forward to ____ you again.', options: ['see', 'seeing', 'saw', 'seen'], answer: 1, explanation: 'look forward to + V-ing.', explanation_en: 'look forward to + V-ing.' },
        { stem: 'His ____ in the play was excellent. (perform)', options: ['perform', 'performer', 'performance', 'performed'], answer: 2, explanation: 'Cần danh từ ⇒ performance.', explanation_en: 'A noun is needed ⇒ performance.' },
        { stem: 'Never ____ I seen such a beautiful view.', options: ['have', 'has', 'had', 'having'], answer: 0, explanation: 'Đảo ngữ với "Never" + present perfect ⇒ have.', explanation_en: 'Inversion with "Never" + present perfect ⇒ have.' },
        { stem: "Choose the antonym of 'expensive'.", options: ['cheap', 'costly', 'dear', 'pricey'], answer: 0, explanation: 'expensive ↔ cheap.', explanation_en: 'expensive ↔ cheap.' },
        { stem: 'Despite ____ tired, he kept working.', options: ['he was', 'being', 'be', 'was'], answer: 1, explanation: 'Despite + V-ing ⇒ being.', explanation_en: 'Despite + V-ing ⇒ being.' },
      ],
    },
    {
      examId: 'anh-hsg-1', title: '🏆 Đề thi HSG — Tiếng Anh 12 (120 phút)', title_en: '🏆 Gifted-student exam — English 12 (120 min)', durationMin: 120,
      questions: [
        { stem: 'No sooner ____ he arrived than it started to rain.', options: ['has', 'have', 'had', 'did'], answer: 2, explanation: 'No sooner + had + S + V3 (đảo ngữ).', explanation_en: 'No sooner + had + S + V3 (inversion).' },
        { stem: 'I suggest that she ____ early tomorrow.', options: ['goes', 'go', 'went', 'going'], answer: 1, explanation: 'Subjunctive: suggest that + S + V nguyên thể.', explanation_en: 'Subjunctive: suggest that + S + base verb.' },
        { stem: 'The book ____ on the table is mine.', options: ['lies', 'lay', 'lain', 'lying'], answer: 3, explanation: 'Rút gọn mệnh đề quan hệ chủ động ⇒ V-ing (lying).', explanation_en: 'Reduced active relative clause ⇒ V-ing (lying).' },
        { stem: 'If I had studied medicine, I ____ a doctor now.', options: ['would be', 'would have been', 'am', 'will be'], answer: 0, explanation: 'Mixed conditional: kết quả ở hiện tại ⇒ would be.', explanation_en: 'Mixed conditional: present result ⇒ would be.' },
        { stem: 'The new policy was very ____ . (controversy)', options: ['controversy', 'controversially', 'controversial', 'controvert'], answer: 2, explanation: 'Cần tính từ ⇒ controversial.', explanation_en: 'An adjective is needed ⇒ controversial.' },
        { stem: '____ was John who broke the window.', options: ['There', 'It', 'This', 'That'], answer: 1, explanation: 'Cleft sentence: It + be + ... + who/that.', explanation_en: 'Cleft sentence: It + be + ... + who/that.' },
        { stem: 'Collocation: "____ a decision".', options: ['do', 'take', 'make', 'have'], answer: 2, explanation: 'make a decision.', explanation_en: 'make a decision.' },
        { stem: 'We need to ____ a new solution. (nghĩ ra)', stem_en: 'We need to ____ a new solution. (to think of)', options: ['put up', 'come up with', 'give up', 'look up'], answer: 1, explanation: 'come up with = nghĩ ra.', explanation_en: 'come up with = to think of.' },
        { stem: "Choose the synonym of 'significant'.", options: ['minor', 'important', 'small', 'weak'], answer: 1, explanation: 'significant ≈ important.', explanation_en: 'significant ≈ important.' },
        { stem: 'Rewrite with "Despite": "Although he was tired, …" → "Despite ____, …"', options: ['he tired', 'be tired', 'being tired', 'tired'], answer: 2, explanation: 'Despite + V-ing ⇒ being tired.', explanation_en: 'Despite + V-ing ⇒ being tired.' },
      ],
    },
  ],
  ...
  TOAN8: [
    ...
    {
      examId: 'toan8-hsg-1', title: '🏆 Đề thi HSG — Toán 8 (120 phút)', durationMin: 120,
      questions: [
        { stem: 'Phân tích $x^4+x^2+1$ thành nhân tử?', options: ['$(x^2+x+1)(x^2-x+1)$', '$(x^2+1)^2$', '$(x^2+x+1)^2$', '$(x^2-1)(x^2+2)$'], answer: 0, explanation: '$(x^2+1)^2-x^2=(x^2-x+1)(x^2+x+1)$.' },
        { stem: 'Cho $a+b+c=0$. Khi đó $a^3+b^3+c^3$ bằng?', options: ['$0$', '$3abc$', '$abc$', '$-3abc$'], answer: 1, explanation: 'Khi $a+b+c=0$ thì $a^3+b^3+c^3=3abc$.' },
        { stem: 'GTNN của $x^2-4x+7$?', options: ['$2$', '$3$', '$7$', '$4$'], answer: 1, explanation: '$(x-2)^2+3\\ge3$.' },
        { stem: 'Với mọi số nguyên $n$, $n^3-n$ chia hết cho?', options: ['$4$', '$5$', '$7$', '$6$'], answer: 3, explanation: 'Tích 3 số nguyên liên tiếp ⇒ chia hết cho 6.' },
        { stem: 'Số nghiệm nguyên dương của $xy=x+y$?', options: ['$0$', '$2$', '$1$', 'vô số'], answer: 2, explanation: '$(x-1)(y-1)=1\\Rightarrow x=y=2$ ⇒ 1 nghiệm.' },
        { stem: 'Với $a,b>0$, GTNN của $(a+b)\\left(\\dfrac1a+\\dfrac1b\\right)$?', options: ['$4$', '$3$', '$2$', '$1$'], answer: 0, explanation: '$=2+\\dfrac ab+\\dfrac ba\\ge4$.' },
        { stem: '$\\triangle ABC$ có $AB=8, AC=6$, phân giác trong $AD$. Tỉ số $\\dfrac{BD}{DC}$?', options: ['$\\dfrac34$', '$\\dfrac43$', '$1$', '$\\dfrac23$'], answer: 1, explanation: '$\\dfrac{BD}{DC}=\\dfrac{AB}{AC}=\\dfrac{8}{6}=\\dfrac43$.' },
        { stem: 'Số dư khi chia $2^{100}$ cho $3$?', options: ['$0$', '$2$', '$1$', '$3$'], answer: 2, explanation: '$2\\equiv-1\\Rightarrow 2^{100}\\equiv1\\ (\\text{mod }3)$.' },
        { stem: 'GTLN của $x(10-x)$?', options: ['$20$', '$30$', '$25$', '$50$'], answer: 2, explanation: '$-(x-5)^2+25\\le25$.' },
        { stem: 'Một tam giác có hai cạnh $5$ và $9$. Cạnh thứ ba nguyên lớn nhất có thể bằng?', options: ['$12$', '$14$', '$15$', '$13$'], answer: 3, explanation: '$|9-5|<a<9+5\\Rightarrow 4<a<14$ ⇒ lớn nhất là $13$.' },
      ],
    },
  ],
  ...
  KHTN8: [
    ...
    {
      examId: 'khtn8-hsg-1', title: '🏆 Đề thi HSG — KHTN 8 (120 phút)', durationMin: 120,
      questions: [
        { stem: 'Cho $5{,}6$ g Fe tác dụng HCl dư. Thể tích $H_2$ (đktc)?', options: ['$1{,}12$ L', '$2{,}24$ L', '$3{,}36$ L', '$4{,}48$ L'], answer: 1, explanation: '$Fe+2HCl\\to FeCl_2+H_2$; $n_{Fe}=0{,}1\\Rightarrow V=2{,}24$ L.' },
        { stem: 'Cân bằng $Al+O_2\\to Al_2O_3$. Hệ số của Al là?', options: ['$2$', '$3$', '$6$', '$4$'], answer: 3, explanation: '$4Al+3O_2\\to 2Al_2O_3$.' },
        { stem: 'Máy thủy lực có $S_2=10S_1$, tác dụng $F_1=50$ N. Lực nâng $F_2$?', options: ['$50$ N', '$5$ N', '$500$ N', '$5000$ N'], answer: 2, explanation: '$F_2=F_1\\cdot\\dfrac{S_2}{S_1}=50\\cdot10=500$ N.' },
        { stem: 'Nhiệt lượng đun $1$ kg nước tăng $50^\\circ C$ ($c=4200$)?', options: ['$21000$ J', '$2100$ J', '$210000$ J', '$420000$ J'], answer: 2, explanation: '$Q=1\\cdot4200\\cdot50=210000$ J.' },
        { stem: 'Kim loại M hóa trị II, $0{,}1$ mol nặng $6{,}5$ g. M là?', options: ['Fe', 'Zn', 'Cu', 'Mg'], answer: 1, explanation: '$M=6{,}5/0{,}1=65\\Rightarrow$ kẽm (Zn).' },
        { stem: 'Đòn bẩy cân bằng: $F_1=60$ N ở $d_1=0{,}2$ m. Lực ở $d_2=0{,}4$ m?', options: ['$15$ N', '$60$ N', '$30$ N', '$120$ N'], answer: 2, explanation: '$F_2=\\dfrac{F_1 d_1}{d_2}=\\dfrac{60\\cdot0{,}2}{0{,}4}=30$ N.' },
        { stem: 'Tim đập $70$ lần/phút, mỗi lần bơm $70$ mL. Lưu lượng tim mỗi phút?', options: ['$4900$ mL', '$490$ mL', '$49$ mL', '$14000$ mL'], answer: 0, explanation: '$70\\times70=4900$ mL.' },
        { stem: 'Hòa tan $25$ g muối vào $75$ g nước. Nồng độ phần trăm?', options: ['$20\\%$', '$25\\%$', '$33\\%$', '$30\\%$'], answer: 1, explanation: '$m_{dd}=100$ g ⇒ $C\\%=25\\%$.' },
        { stem: 'Một máy có công có ích $750$ J, công toàn phần $1000$ J. Hiệu suất?', options: ['$70\\%$', '$80\\%$', '$75\\%$', '$25\\%$'], answer: 2, explanation: '$H=750/1000=75\\%$.' },
        { stem: 'Tiêm vaccine giúp cơ thể tạo loại miễn dịch nào?', options: ['thụ động', 'chủ động', 'bẩm sinh', 'không có'], answer: 1, explanation: 'Cơ thể tự sinh kháng thể ⇒ miễn dịch chủ động.' },
      ],
    },
  ],
  ...
  ANH8: [
    ...
    {
      examId: 'anh8-hsg-1', title: '🏆 Đề thi HSG — Tiếng Anh 8 (100 phút)', durationMin: 100,
      questions: [
        { stem: 'If I ____ you, I would study harder.', options: ['am', 'was', 'were', 'will be'], answer: 2, explanation: 'Điều kiện loại 2 ⇒ were.' },
        { stem: 'Never ____ I seen such a beautiful place.', options: ['have', 'has', 'had', 'having'], answer: 0, explanation: 'Đảo ngữ với "Never" + present perfect ⇒ have.' },
        { stem: 'The window ____ yesterday.', options: ['breaks', 'broke', 'was broken', 'is broken'], answer: 2, explanation: 'Bị động quá khứ ⇒ was broken.' },
        { stem: 'The boy ____ bike was stolen felt sad.', options: ['who', 'which', 'whose', 'where'], answer: 2, explanation: 'Chỉ sở hữu ⇒ whose.' },
        { stem: 'She said she ____ very busy.', options: ['is', 'was', 'will', 'be'], answer: 1, explanation: 'Tường thuật lùi thì ⇒ was.' },
        { stem: 'He is the ____ student in his class. (good)', options: ['good', 'better', 'well', 'best'], answer: 3, explanation: 'So sánh nhất bất quy tắc ⇒ the best.' },
        { stem: 'I avoid ____ junk food.', options: ['eat', 'to eat', 'eating', 'ate'], answer: 2, explanation: 'avoid + V-ing.' },
        { stem: 'If she had studied, she ____ passed the exam.', options: ['will have', 'would', 'had', 'would have'], answer: 3, explanation: 'Điều kiện loại 3 ⇒ would have + V3.' },
        { stem: 'He answered all the questions ____ . (correct)', options: ['correct', 'correctly', 'correction', 'corrected'], answer: 1, explanation: 'Cần trạng từ ⇒ correctly.' },
        { stem: "Choose the synonym of 'difficult'.", options: ['easy', 'hard', 'simple', 'light'], answer: 1, explanation: 'difficult = hard.' },
      ],
    },
  ],
};
