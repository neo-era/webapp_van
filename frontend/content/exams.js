...
const EXAMS = {
  ...
  ANH: [
    ...
    {
      examId: 'anh-hsg-1', title: '🏆 Đề thi HSG — Tiếng Anh 12 (120 phút)', durationMin: 120,
      questions: [
        { stem: 'No sooner ____ he arrived than it started to rain.', options: ['has', 'have', 'had', 'did'], answer: 2, explanation: 'No sooner + had + S + V3 (đảo ngữ).' },
        { stem: 'I suggest that she ____ early tomorrow.', options: ['goes', 'go', 'went', 'going'], answer: 1, explanation: 'Subjunctive: suggest that + S + V nguyên thể.' },
        { stem: 'The book ____ on the table is mine.', options: ['lies', 'lay', 'lain', 'lying'], answer: 3, explanation: 'Rút gọn mệnh đề quan hệ chủ động ⇒ V-ing (lying).' },
        { stem: 'If I had studied medicine, I ____ a doctor now.', options: ['would be', 'would have been', 'am', 'will be'], answer: 0, explanation: 'Mixed conditional: kết quả ở hiện tại ⇒ would be.' },
        { stem: 'The new policy was very ____ . (controversy)', options: ['controversy', 'controversially', 'controversial', 'controvert'], answer: 2, explanation: 'Cần tính từ ⇒ controversial.' },
        { stem: '____ was John who broke the window.', options: ['There', 'It', 'This', 'That'], answer: 1, explanation: 'Cleft sentence: It + be + ... + who/that.' },
        { stem: 'Collocation: "____ a decision".', options: ['do', 'take', 'make', 'have'], answer: 2, explanation: 'make a decision.' },
        { stem: 'We need to ____ a new solution. (nghĩ ra)', options: ['put up', 'come up with', 'give up', 'look up'], answer: 1, explanation: 'come up with = nghĩ ra.' },
        { stem: "Choose the synonym of 'significant'.", options: ['minor', 'important', 'small', 'weak'], answer: 1, explanation: 'significant ≈ important.' },
        { stem: 'Rewrite with "Despite": "Although he was tired, …" → "Despite ____, …"', options: ['he tired', 'be tired', 'being tired', 'tired'], answer: 2, explanation: 'Despite + V-ing ⇒ being tired.' },
      ],
    },
  ],
