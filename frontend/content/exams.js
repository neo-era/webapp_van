...
const EXAMS = {
  ...
  HOA: [
    ...
    {
      examId: 'hoa-thptqg-1', title: '🎯 Đề thi thử THPT QG — Hóa học (theo cấu trúc, 50 phút)', durationMin: 50,
      questions: [
        { stem: 'Số mol trong $8$ g NaOH ($M=40$)?', options: ['$0{,}1$', '$0{,}2$', '$0{,}4$', '$0{,}8$'], answer: 1, explanation: '$n=8/40=0{,}2$ mol.' },
        { stem: 'Thủy phân ester đơn chức trong NaOH theo tỉ lệ mol ester : NaOH là?', options: ['$1:1$', '$1:2$', '$2:1$', '$1:3$'], answer: 0, explanation: '$RCOOR\'+NaOH\\to RCOONa+R\'OH$ ⇒ 1 : 1.' },
        { stem: 'Công thức phân tử của glucose là?', options: ['$C_{12}H_{22}O_{11}$', '$C_6H_{12}O_6$', '$C_6H_{10}O_5$', '$CH_2O$'], answer: 1, explanation: 'Glucose là $C_6H_{12}O_6$.' },
        { stem: 'Kim loại nào sau đây KHÔNG tác dụng với dung dịch HCl?', options: ['Fe', 'Zn', 'Mg', 'Cu'], answer: 3, explanation: 'Cu đứng sau H trong dãy điện hóa.' },
        { stem: 'Phần trăm khối lượng H trong $H_2O$ ($M=18$)?', options: ['$11{,}1\\%$', '$88{,}9\\%$', '$50\\%$', '$8\\%$'], answer: 0, explanation: '$2/18\\cdot100\\%\\approx11{,}1\\%$.' },
        { stem: 'Polime nào được điều chế từ etilen?', options: ['PVC', 'PS', 'PE', 'cao su buna'], answer: 2, explanation: 'PE $(-CH_2-CH_2-)_n$ từ etilen $C_2H_4$.' },
        { stem: 'Số mol $H_2$ sinh ra khi $0{,}1$ mol Zn tác dụng HCl dư?', options: ['$0{,}05$', '$0{,}1$', '$0{,}2$', '$0{,}3$'], answer: 1, explanation: '$Zn+2HCl\\to ZnCl_2+H_2$ ⇒ $n_{H_2}=0{,}1$.' },
        { stem: 'Amino acid trong phân tử có các nhóm chức nào?', options: ['chỉ $-NH_2$', 'chỉ $-COOH$', '$-NH_2$ và $-COOH$', 'chỉ $-OH$'], answer: 2, explanation: 'Có cả nhóm amino và carboxyl ⇒ tính lưỡng tính.' },
        { stem: 'Nhiệt phân $CaCO_3$ thu được CaO và khí gì?', options: ['$O_2$', '$CO_2$', '$H_2O$', '$CO$'], answer: 1, explanation: '$CaCO_3\\to CaO+CO_2$.' },
        { stem: 'Khối lượng mol của $CH_3COOH$?', options: ['$46$', '$74$', '$60$', '$32$'], answer: 2, explanation: '$C_2H_4O_2=24+4+32=60$ g/mol.' },
        { stem: 'Phản ứng ester hóa giữa acid và ancol thuộc loại?', options: ['một chiều', 'thuận nghịch', 'trao đổi', 'oxi hóa – khử'], answer: 1, explanation: 'Phản ứng ester hóa là thuận nghịch.' },
        { stem: 'Kim loại nào dẫn điện tốt nhất?', options: ['Cu', 'Ag', 'Au', 'Al'], answer: 1, explanation: 'Bạc (Ag) dẫn điện tốt nhất.' },
      ],
    },
    {
