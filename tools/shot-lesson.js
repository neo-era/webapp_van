...
(async () => {
  ...
  const info = await p.evaluate(() => {
    ...
    App.state.tab = 'learn';
    App.state.learn = { view: 'lesson', subjectCode: 'TOAN', subjectName: 'Toán', topicId: 't-toan-c1', topicTitle: 'Chương 1', lessonId: 'l-toan-khaosat', lessonTitle: 'Khảo sát' };
    switchTab('learn');
    return true;
  });
  await wait(700);
  await p.screenshot({ path: path.join(ROOT, 'screenshots', 'lesson-khaosat.png'), fullPage: true });
